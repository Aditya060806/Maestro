...
```bash
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py analyze article.md --keyword "<keyword>"
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py readability article.md
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py keywords article.md --keyword "<keyword>"
