...
```bash
~/.maestro/agents/scripts/youtube-helper.sh auth-test
```
...
```bash
~/.maestro/agents/scripts/youtube-helper.sh channel @handle
```
...
```bash
~/.maestro/agents/scripts/youtube-helper.sh competitors @myhandle @comp1 @comp2 @comp3
```
