...
```bash
~/.maestro/agents/scripts/memory-helper.sh recall --namespace youtube "channel"
```
...
```bash
~/.maestro/agents/scripts/youtube-helper.sh channel @competitor
~/.maestro/agents/scripts/youtube-helper.sh videos @competitor 50
```
...
```bash
~/.maestro/agents/scripts/memory-helper.sh store \
...
```bash
~/.maestro/agents/scripts/youtube-helper.sh video VIDEO_ID
~/.maestro/agents/scripts/youtube-helper.sh transcript VIDEO_ID
```
