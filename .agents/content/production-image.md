...
thumbnail-helper.sh batch-score ~/.cache/maestro/thumbnails/[output_dir]/
thumbnail-helper.sh ab-test VIDEO_ID ~/.cache/maestro/thumbnails/[output_dir]/
...
**Storage**: `~/.maestro/.agent-workspace/work/[project]/style-library/` or version-control in content repo.
