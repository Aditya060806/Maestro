...
```bash
~/.maestro/agents/scripts/accessibility-helper.sh audit <url>
~/.maestro/agents/scripts/accessibility-helper.sh playwright-contrast <url>
~/.maestro/agents/scripts/accessibility-audit-helper.sh axe <url>
```
