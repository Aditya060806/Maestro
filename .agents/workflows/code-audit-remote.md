...
- **Script**: `~/.maestro/agents/scripts/code-audit-helper.sh`
- **When**: PR review phase, after local linting passes
- **Position**: `/linters-local` -> `/code-audit-remote` -> `/pr` summary

```bash
# Run all remote audits
bash ~/.maestro/agents/scripts/code-audit-helper.sh audit [repo]

# Report / status
bash ~/.maestro/agents/scripts/code-audit-helper.sh report [repo] [output.json]
bash ~/.maestro/agents/scripts/code-audit-helper.sh summary
bash ~/.maestro/agents/scripts/code-audit-helper.sh status
bash ~/.maestro/agents/scripts/code-audit-helper.sh check-regression
bash ~/.maestro/agents/scripts/code-audit-helper.sh reset

# Individual service collectors
bash ~/.maestro/agents/scripts/coderabbit-cli.sh review
bash ~/.maestro/agents/scripts/coderabbit-cli.sh analyze .agents/scripts/
bash ~/.maestro/agents/scripts/codacy-cli.sh analyze
bash ~/.maestro/agents/scripts/codacy-cli.sh upload results.sarif
bash ~/.maestro/agents/scripts/sonarcloud-cli.sh analyze
```
