...
**MANDATORY**: Use this single command for ALL maestro releases:
...
## Manual Release (Non-maestro Repos)
...
**Deploy** (maestro only): `cd ~/Git/maestro && ./setup.sh`
...
${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/worktree-helper.sh add hotfix/v{NEW_PATCH} --base v{CURRENT}
