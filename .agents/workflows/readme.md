...
**Dynamic counts (maestro repo):** `readme-helper.sh check|update|update --apply`
**Repo metrics (all repos):** `repo-metrics-helper.sh generate` or `maestro metrics generate`
