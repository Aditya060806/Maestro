...
1. Run: `~/.maestro/agents/scripts/memory-helper.sh recall "{query}"`
...
```bash
~/.maestro/agents/scripts/memory-helper.sh validate
~/.maestro/agents/scripts/memory-helper.sh prune --dry-run
~/.maestro/agents/scripts/memory-helper.sh prune
```
