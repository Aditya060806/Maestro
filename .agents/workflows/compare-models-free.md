...
```bash
~/.maestro/agents/scripts/compare-models-helper.sh list                        # all models
~/.maestro/agents/scripts/compare-models-helper.sh compare <model1> <model2>  # specific models
~/.maestro/agents/scripts/compare-models-helper.sh recommend "<task>"         # task-based recommendation
~/.maestro/agents/scripts/compare-models-helper.sh pricing                    # pricing overview
~/.maestro/agents/scripts/compare-models-helper.sh capabilities               # capability matrix
```
...
- maestro tier mapping (haiku/flash/sonnet/pro/opus)
