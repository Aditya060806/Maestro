...
```bash
~/.maestro/agents/scripts/show-plan-helper.sh $ARGUMENTS
```
...
```bash
/show-plan opencode              # Show maestro-opencode Plugin plan
...
1. **"1"** - Begin working on the plan:
   1. Run `~/.maestro/agents/scripts/pre-edit-check.sh`
