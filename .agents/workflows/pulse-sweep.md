...
For framework-level problems (`~/.maestro/` files, framework scripts, supervisor/pulse logic), file on `Aditya060806/Maestro`:

```bash
~/.maestro/agents/scripts/framework-issue-helper.sh detect "description"  # exit 0 = framework
