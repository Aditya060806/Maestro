...
**Dynamic Counts (maestro repo)**:

```bash
~/.maestro/agents/scripts/readme-helper.sh check    # check staleness
~/.maestro/agents/scripts/readme-helper.sh counts   # current counts
~/.maestro/agents/scripts/readme-helper.sh update --apply  # apply updates
```
