...
```bash
~/.maestro/agents/scripts/memory-helper.sh recall --type SUCCESS_PATTERN --limit 10
~/.maestro/agents/scripts/memory-helper.sh recall --type FAILURE_PATTERN --limit 10
```
