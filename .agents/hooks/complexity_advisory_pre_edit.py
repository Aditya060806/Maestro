...
Location: ~/.maestro/hooks/complexity_advisory_pre_edit.py
...
# Configurable via MAESTRO_COMPLEXITY_WARN_THRESHOLD env var.
_DEFAULT_THRESHOLD = 80
COMPLEXITY_WARN_THRESHOLD = int(
    os.environ.get("MAESTRO_COMPLEXITY_WARN_THRESHOLD", str(_DEFAULT_THRESHOLD))
)
