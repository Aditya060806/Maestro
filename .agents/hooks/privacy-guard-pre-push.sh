...
# private repo slug (from ~/.config/maestro/repos.json) or local/private path
...
HELPER_DEPLOYED="${HOME}/.maestro/agents/scripts/privacy-guard-helper.sh"
...
# the scan surface via PRIVACY_SCAN_GLOBS / PRIVACY_SCAN_GLOBS_TEXT; maestro
