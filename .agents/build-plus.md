...
- Draft agents: `~/.maestro/agents/draft/` with `status: draft`. See `tools/build-agent/build-agent.md`.
...
```bash
~/.maestro/agents/scripts/planning-commit-helper.sh "plan: {description}"
```
