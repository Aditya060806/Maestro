...
const OVERLOAD_RECOVERY_NOTE = "maestro attempted automatic recovery for this OpenAI overload. If the request still stopped, use the prepared continuation prompt to pick up where the work left off.";
