...
```bash
MAESTRO_SKIP_PREDISPATCH_VALIDATOR=1 ./pulse-wrapper.sh
```
...
**Marker:** `<!-- maestro:generator=ratchet-down -->`
...
**Bypass:** `MAESTRO_SKIP_REVIEW_FEEDBACK_SUPERSESSION=1`
...
2. Emit the marker in the issue body: `<!-- maestro:generator=my-generator -->`
...
.agents/scripts/pre-dispatch-validator-helper.sh validate <issue-number> Aditya060806/Maestro
```
