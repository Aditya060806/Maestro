...
immediately preceding the dispatch in `~/.maestro/logs/pulse.log`. If
...
**Canonical evidence.** `~/.maestro/logs/worker-20967.log` — worker
created `maestro-bugfix-gh-20967-caller-permissions/` worktree
