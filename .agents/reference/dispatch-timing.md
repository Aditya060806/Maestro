...
~/.maestro/logs/dispatch-stages.tsv — TSV log (append-only)
```
...
```text
2026-04-29T01:15:30Z	#21500	Aditya060806/Maestro	gh_issue_view	1250
2026-04-29T01:15:32Z	#21500	Aditya060806/Maestro	dedup_check	2100
2026-04-29T01:15:33Z	#21500	Aditya060806/Maestro	brief_freshness	45
```
...
```bash
awk -F'\t' '{print $4 "\t" $5}' ~/.maestro/logs/dispatch-stages.tsv | \
    sort -k1,1 -k2,2n | \
    awk -F'\t' '
...
|----------|---------|-------------|
| `MAESTRO_DISPATCH_STAGES_LOG` | `~/.maestro/logs/dispatch-stages.tsv` | Log file path |
| `MAESTRO_DISPATCH_STAGES_LOG_MAX_LINES` | `50000` | Trim threshold |
| `MAESTRO_DISPATCH_STAGES_DISABLE` | `0` | Set `1` to no-op all recording |
