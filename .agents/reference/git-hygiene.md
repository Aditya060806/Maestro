...
Common git state problems that cause confusing failures in the maestro workflow,
...
```bash
export MAESTRO_SHALLOW_UNSHALLOW=0
```
...
Multi-runner maestro setups and CI environments frequently produce shallow clones
