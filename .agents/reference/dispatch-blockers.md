...
This is the **single source of truth** for labels, states, and conditions that block automated worker dispatch or auto-merge. Maintained here to support Phase 4 of [#20402](https://github.com/Aditya060806/Maestro/issues/20402) (inverting the dispatch default from opt-in to opt-out).
...
| `needs-maintainer-review` | `pulse-nmr-approval.sh` `auto_approve_maintainer_issues` | Requires maintainer cryptographic approval (`sudo maestro approve issue <N>`) before dispatch. |
