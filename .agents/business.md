...
Create via `runner-helper.sh`. Each runner gets a personality file at `~/.maestro/.agent-workspace/runners/<name>/AGENTS.md`. Full templates and bootstrap script: `business/company-runners.md`.
