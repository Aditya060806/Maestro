...
- **Auth**: `X-API-KEY` header — key stored in `~/.config/maestro/credentials.sh` as `NEURONWRITER_API_KEY`
...
2. Store: `bash ~/.maestro/agents/scripts/setup-local-api-keys.sh set NEURONWRITER_API_KEY "your_api_key"`
