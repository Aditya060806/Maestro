...
- **Storage**: `~/.maestro/.agent-workspace/work/seo-data/{domain}/`
...
File naming: `{source}-{start-date}-{end-date}.toon` — stored under `~/.maestro/.agent-workspace/work/seo-data/{domain}/`.
...
export GOOGLE_APPLICATION_CREDENTIALS="$HOME/.config/maestro/gsc-credentials.json"
```
