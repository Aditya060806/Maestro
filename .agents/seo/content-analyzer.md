...
- **Script**: `~/.maestro/agents/scripts/seo-content-analyzer.py`

## Analysis Pipeline

```bash
# Full analysis
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py analyze article.md \
  --keyword "primary keyword" --secondary "secondary1,secondary2"

# Individual modules
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py readability article.md
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py keywords article.md \
  --keyword "primary keyword" --secondary "secondary1,secondary2"
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py intent "target keyword"
python3 ~/.maestro/agents/scripts/seo-content-analyzer.py quality article.md \
