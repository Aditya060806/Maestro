...
- **Helper**: `~/.maestro/agents/scripts/site-crawler-helper.sh`
...
- **Config**: `~/.config/maestro/site-crawler.json`
...
`~/.config/maestro/site-crawler.json`:
...
```json
{
  ...
  "respect_robots": true,
  "render_js": false,
  "user_agent": "Maestro-Crawler/1.0",
  "request_delay": 100,
