...
1. Read `~/.maestro/agents/seo/ai-search-readiness.md`
...
3. Score material recommendations with `~/.maestro/agents/seo/ai-search-scoring.md`
4. Return report-ready output using `~/.maestro/agents/seo/ai-search-report-template.md`:
