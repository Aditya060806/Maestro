...
- **Helper**: `~/.maestro/agents/scripts/tech-stack-helper.sh`
...
4. **Optional**: BuiltWith API key for fallback: `maestro secret set BUILTWITH_API_KEY`
...
Cache path: `~/.maestro/.agent-workspace/work/tech-stack/cache/`
