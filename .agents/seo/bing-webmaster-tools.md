...
- **Credentials**: `~/.config/maestro/credentials.sh` → `BING_API_KEY`
...
2. Add to `~/.config/maestro/credentials.sh`: `export BING_API_KEY="your_api_key_here"`
3. `source ~/.config/maestro/credentials.sh`
