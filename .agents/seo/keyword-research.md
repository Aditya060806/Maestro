...
- **Config**: `~/.config/maestro/keyword-research.json`
...
Config (`~/.config/maestro/keyword-research.json`): `default_locale`, `default_provider`, `default_limit` (100), `include_ahrefs` (false), `csv_directory` (`~/Downloads`).
