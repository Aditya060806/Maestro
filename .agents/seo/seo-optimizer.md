...
1. **Analyse**: `python3 ~/.maestro/agents/scripts/seo-content-analyzer.py quality article.md --keyword "target keyword" --meta-title "Current Title" --meta-desc "Current description"`
