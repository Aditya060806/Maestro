...
**Pro/Premium**: Require license activation via vendor dashboards. Keys in `~/.config/maestro/credentials.sh` (see `api-key-setup.md`). Git Updater for Git-hosted plugin updates.
