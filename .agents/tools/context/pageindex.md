...
## Corpus-Wide Usage (maestro t2850)

The maestro framework extends PageIndex from single-document to corpus-wide retrieval
...
maestro knowledge search "invoice Q1 2026"
```
...
Reference: `.agents/maestro/knowledge-plane.md` § "Corpus Index (t2850)"
