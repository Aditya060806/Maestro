...
maestro does not install GitHub search MCPs. If you have Oh-My-OpenCode, it provides `grep_app`. This subagent is the built-in zero-overhead alternative — use it when you don't have Oh-My-OpenCode or prefer CLI-native search.
