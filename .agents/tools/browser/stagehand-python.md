...
| Virtual env | `~/.maestro/stagehand-python/.venv/` |
| Config | `~/.maestro/stagehand-python/.env` |
...
- MCP integrations: `.agents/maestro/mcp-integrations.md`
