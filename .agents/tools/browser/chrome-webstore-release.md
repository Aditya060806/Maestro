...
```bash
maestro secret set CWS_CLIENT_ID
maestro secret set CWS_CLIENT_SECRET
maestro secret set CWS_REFRESH_TOKEN
maestro secret set CWS_PUBLISHER_ID
maestro secret set CWS_EXTENSION_ID
...
- Use `maestro secret set` for encrypted credential management
