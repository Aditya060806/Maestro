...
| The flow needs a managed persistent profile that maestro can keep reusing | `tools/browser/dev-browser.md` | Better long-lived state than a user-owned live browser |
