...
- **Reports**: `~/.maestro/reports/pagespeed/`
...
./.agents/scripts/pagespeed-helper.sh report ~/.maestro/reports/pagespeed/lighthouse_20241110_143022.json
...
`~/.maestro/reports/pagespeed/` — `pagespeed_YYYYMMDD_HHMMSS_desktop.json` | `lighthouse_YYYYMMDD_HHMMSS.html` | `lighthouse_YYYYMMDD_HHMMSS.json`
