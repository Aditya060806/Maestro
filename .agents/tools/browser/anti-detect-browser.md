...
```bash
~/.maestro/agents/scripts/anti-detect-helper.sh setup
~/.maestro/agents/scripts/anti-detect-helper.sh profile create "my-account"
~/.maestro/agents/scripts/anti-detect-helper.sh launch --profile "my-account"                    # Camoufox (full anti-detect)
~/.maestro/agents/scripts/anti-detect-helper.sh launch --profile "my-account" --engine chromium  # rebrowser-patches (faster)
~/.maestro/agents/scripts/anti-detect-helper.sh launch --profile "my-account" --engine mullvad   # Mullvad Browser
~/.maestro/agents/scripts/anti-detect-helper.sh test --profile "my-account"
~/.maestro/agents/scripts/anti-detect-helper.sh profile clean "my-account"
```
