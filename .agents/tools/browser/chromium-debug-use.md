...
Use this path only when maestro explicitly needs to inspect or automate your live Chromium-family browser. Do not leave remote debugging enabled as a standing default.
...
| Persistent local profile managed by maestro | `tools/browser/dev-browser.md` |
