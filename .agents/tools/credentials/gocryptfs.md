...
- **Vault storage**: `~/.maestro/.agent-workspace/vaults/`
- **Mount points**: `~/.maestro/.agent-workspace/mounts/`
...
ls ~/.maestro/.agent-workspace/mounts/project-secrets/
echo "sensitive data" > ~/.maestro/.agent-workspace/mounts/project-secrets/data.txt
...
```text
                    ...
                    gocryptfs-helper.sh open <name>
                           |
              ~/.maestro/.agent-workspace/vaults/<name>/
              (AES-256-GCM encrypted files + gocryptfs.conf)
                           |
                    FUSE filesystem mount
                           |
              ~/.maestro/.agent-workspace/mounts/<name>/
