...
- `Univers LT Pro Condensed Regular/Bold`
- `TX 02 Data Regular`
- `SF Mono`
- `IoskeleyMono suggestion for report-compatible body/code`

## Report substitutions

- Heading: `"Univers LT Pro Condensed", "Arial Narrow", "Roboto Condensed", Arial, sans-serif`
- Body: `"IoskeleyMono", Menlo, Monaco, Consolas, monospace`
- Code/data: `"IoskeleyMono", Menlo, Monaco, Consolas, monospace`
