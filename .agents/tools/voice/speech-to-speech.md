...
- **Install dir**: `~/.maestro/.agent-workspace/work/speech-to-speech/`
...
> **Security:** Store `OPENAI_API_KEY` via `maestro secret set OPENAI_API_KEY`. Never hardcode keys. See `tools/credentials/api-key-setup.md`.
