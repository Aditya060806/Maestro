...
```bash
~/.maestro/agents/scripts/linters-local.sh                              # all checks
...
~/.maestro/agents/scripts/secretlint-helper.sh scan                    # Secrets
```
...
| File type | Format |
|-----------|--------|
| .sh, .py, .txt | `# SPDX-License-Identifier: MIT` + `# SPDX-FileCopyrightText: 2025-2026 Aditya Pandey and Harvest` |
| .md | `<!-- SPDX-License-Identifier: MIT -->` + `<!-- SPDX-FileCopyrightText: 2025-2026 Aditya Pandey and Harvest -->` |
