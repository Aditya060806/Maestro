...
```bash
~/.maestro/agents/scripts/compare-models-helper.sh list
~/.maestro/agents/scripts/compare-models-helper.sh compare claude-sonnet-4-6 gpt-4o
~/.maestro/agents/scripts/compare-models-helper.sh recommend "code review"
~/.maestro/agents/scripts/compare-models-helper.sh pricing
```
...
```bash
~/.maestro/agents/scripts/compare-models-helper.sh patterns
~/.maestro/agents/scripts/compare-models-helper.sh patterns --task-type code-review
```
...
2. **maestro tier mapping**: How models map to haiku/flash/sonnet/pro/opus tiers
...
```bash
~/.maestro/agents/scripts/compare-models-helper.sh discover           # check configured API keys
~/.maestro/agents/scripts/compare-models-helper.sh discover --probe   # verify keys work
~/.maestro/agents/scripts/compare-models-helper.sh discover --list-models  # list live models
~/.maestro/agents/scripts/compare-models-helper.sh discover --json    # machine-readable
```

Key lookup order: env vars → gopass secrets → `~/.config/maestro/credentials.sh`.

## Live Model Benchmarking (t1393)

```bash
~/.maestro/agents/scripts/compare-models-helper.sh bench "Explain quicksort" claude-sonnet-4-6 gpt-4o
~/.maestro/agents/scripts/compare-models-helper.sh bench "Explain quicksort" claude-sonnet-4-6 gpt-4o gemini-2.5-pro --judge
~/.maestro/agents/scripts/compare-models-helper.sh bench --dataset prompts.jsonl claude-sonnet-4-6 gpt-4.1 --judge
~/.maestro/agents/scripts/compare-models-helper.sh bench "What is 2+2?" claude-sonnet-4-6 gpt-4o --dry-run
~/.maestro/agents/scripts/compare-models-helper.sh bench --history --limit 10
```
...
Results stored at `~/.maestro/.agent-workspace/observability/bench-results.jsonl`.
...
- `tools/context/model-routing.md` - Cost-aware model routing within maestro
