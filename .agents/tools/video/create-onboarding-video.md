...
Adapted from the public `create-onboarding-video` skill referenced by the user, with maestro additions for `DESIGN.md`, authorised browser capture, and branded wallpaper-style foreground composition.
