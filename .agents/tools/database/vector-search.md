...
- **Scope**: Application-level vector search — NOT for maestro internal use (which stays on SQLite FTS5)
...
- `reference/memory.md` — SQLite FTS5 (maestro cross-session memory, NOT app vector search)
