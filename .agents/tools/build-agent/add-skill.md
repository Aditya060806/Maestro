---
description: Import and convert external skills to maestro format
mode: subagent
---
...
Ingest skills from external sources (GitHub repos, ClawdHub registry) and transpose them to maestro format while preserving all knowledge and handling conflicts.
...
| `AGENTS.md` | maestro/Windsurf | Direct copy, ensure `mode: subagent`. |
