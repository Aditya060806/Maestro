...
**Secure storage**: `~/.config/maestro/` (600 permissions). Never store tokens in repository files.
...
# or
echo "GITHUB_TOKEN=ghp_xxxx" >> ~/.config/maestro/credentials.sh
...
# or
echo "GITLAB_TOKEN=glpat-xxxx" >> ~/.config/maestro/credentials.sh
chmod 600 ~/.config/maestro/credentials.sh
```
...
# or
echo "GITEA_TOKEN=xxxx" >> ~/.config/maestro/credentials.sh
chmod 600 ~/.config/maestro/credentials.sh
```
...
- **600 permissions** on `~/.config/maestro/credentials.sh`
