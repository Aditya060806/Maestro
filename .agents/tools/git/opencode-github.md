...
```bash
~/.maestro/agents/scripts/opencode-github-setup-helper.sh check
```
...
OpenCode respects maestro branch naming (`feature/`, `bugfix/`, etc.) and triggers existing CI workflows. Configure the prompt for maestro conventions:
