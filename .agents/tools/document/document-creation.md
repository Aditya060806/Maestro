...
**Template storage**: `~/.maestro/.agent-workspace/templates/` (documents/, spreadsheets/, presentations/)
...
# Tier 2 (Python venv at ~/.maestro/.agent-workspace/python-env/document-creation/)
python3 -m venv ~/.maestro/.agent-workspace/python-env/document-creation
source ~/.maestro/.agent-workspace/python-env/document-creation/bin/activate
