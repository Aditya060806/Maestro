...
- **Reports**: `~/.maestro/reports/accessibility/`
...
cron-helper.sh add "accessibility-audit" \
  "0 6 * * 1" \
  "accessibility-helper.sh bulk ~/.maestro/reports/accessibility/monitored-urls.txt"

# Track scores over time
jq -r '.categories.accessibility.score * 100' \
  ~/.maestro/reports/accessibility/lighthouse_a11y_*.json
```
