---
description: Security best practices for Maestro
mode: subagent
tools:
  read: true
  write: false
...
API key compliance, incident response, provider rotation: `maestro/security-requirements.md`.

## Credential Management

- Store in `~/.config/maestro/credentials.sh` (600 perms) or gopass — never in source
