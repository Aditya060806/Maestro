---
description: Feature comparison between maestro and Claude-Flow
mode: subagent
tools:
  read: true
  write: false
...
| Area | Claude-Flow | maestro | Status | Why |
|------|-------------|----------|--------|-----|
...
| WASM transforms | Agent Booster | Not adopted | Skipped | The Edit tool is already fast enough for the file sizes maestro handles |

## Scale Fit

maestro keeps the Claude-Flow ideas that improve human-scale agent work and drops the ones aimed at much larger systems. Claude-Flow targets thousands of agents, millions of memories, and real-time routing. maestro targets 1-5 agents, hundreds of memories, and session-scoped routing, so guidance, optional embeddings, and mailbox coordination are usually enough.
