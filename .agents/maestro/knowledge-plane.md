...
- Repo mode root: `<repo>/_knowledge/`; personal mode root:
  `~/.maestro/.agent-workspace/knowledge/`.
...
- Provision with `maestro knowledge init repo`, `maestro knowledge init personal`,
  or idempotently repair with `maestro knowledge provision`.
...
```bash
maestro knowledge init repo
maestro knowledge init personal
maestro knowledge provision
maestro knowledge status
