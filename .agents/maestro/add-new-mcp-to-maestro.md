...
# Adding New MCP Integrations to Maestro
...
> Available: Build+, Accounts, Maestro, Content, Health, Legal, Marketing, Research, Sales, SEO, WordPress
> Common patterns: codebase/context tools → Build+, Maestro, Research; domain-specific → relevant domain only"
...
~/.maestro/agents/scripts/opencode-test-helper.sh test-mcp {mcp-name} Build+
```
