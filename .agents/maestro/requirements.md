...
- **Quality check**: `curl -s "https://sonarcloud.io/api/measures/component?component=Aditya060806_maestro&metricKeys=bugs,vulnerabilities,code_smells"`
...
```bash
# SonarCloud status
curl -s "https://sonarcloud.io/api/measures/component?component=Aditya060806_maestro&metricKeys=bugs,vulnerabilities,code_smells"

# CodeFactor status
curl -s "https://www.codefactor.io/repository/github/Aditya060806/Maestro"
