...
maestro knowledge enrich <source-id>
...
```bash
# Query via CLI
maestro knowledge search "all invoices over £5k"
...
`maestro knowledge search` auto-routes to `knowledge-index-helper.sh query` when the
...
~/.maestro/agents/scripts/knowledge-index-helper.sh build

# Build tree for one source
~/.maestro/agents/scripts/knowledge-index-helper.sh build-source <source-id>

# Query the corpus
~/.maestro/agents/scripts/knowledge-index-helper.sh query "invoice 2026"

# Show index state
~/.maestro/agents/scripts/knowledge-index-helper.sh status
```
...
~/.maestro/agents/scripts/knowledge-review-helper.sh tick

# Explicit promotion (called automatically by approve hook)
~/.maestro/agents/scripts/knowledge-review-helper.sh promote <source-id>

# Manual audit entry
~/.maestro/agents/scripts/knowledge-review-helper.sh audit-log <action> <source-id> [extra]
```
