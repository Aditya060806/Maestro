...
| `maestro/memory-patterns.md` | 48 | 6 | simple | haiku | 2 |
| `reference/self-improvement.md` | 59 | 8 | simple | haiku | 2 |
| `reference/task-taxonomy.md` | 63 | 2 | simple | haiku | 3 |
| `maestro/graduated-learnings.md` | 69 | 12 | moderate | haiku | 2 |
| `reference/agent-routing.md` | 69 | 5 | simple | haiku | 3 |
| `workflows/pre-edit.md` | 78 | 6 | simple | haiku | 3 |
| `maestro/security.md` | 80 | 5 | simple | haiku | 2 |
| `maestro/configs.md` | 89 | 10 | moderate | haiku | 2 |
| `prompts/worker-efficiency-protocol.md` | 106 | 8 | moderate | sonnet | 3 |
| `maestro/architecture.md` | 124 | 15 | complex | sonnet | 3 |
| `maestro/onboarding.md` | 130 | 12 | moderate | haiku | 2 |
