...
# Voice Helper Script
# Manages the maestro voice bridge (talk to OpenCode via speech)
...
readonly S2S_DIR="${HOME}/.maestro/.agent-workspace/work/speech-to-speech"
readonly VENV_DIR="${S2S_DIR}/.venv"
readonly VOICE_PID_FILE="${HOME}/.maestro/.agent-workspace/tmp/.voice-bridge.pid"
...
text = 'Hello, I am your Maestro assistant.'
