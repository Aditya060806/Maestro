...
# Email Export Helper for Maestro Framework
...
readonly DEFAULT_EXPORT_BASE="${HOME}/.maestro/.agent-workspace/email-case-exports"
...
show_help() {
	cat <<'HELP'
Email Export Helper - Maestro Framework
