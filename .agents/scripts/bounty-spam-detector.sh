...
#
# Canonical incident: Aditya060806/Maestro PRs #21077, #21094, #21101
...
readonly BSD_REFERENCE_URL_DEFAULT="https://github.com/Aditya060806/Maestro/issues/21100"
...
EXAMPLES:
  ...
  bounty-spam-detector.sh check pr 21077 --repo Aditya060806/Maestro

  # JSON breakdown:
  bounty-spam-detector.sh score pr 21077 --repo Aditya060806/Maestro --json

  # Dry-run close (shows comment, takes no action):
  bounty-spam-detector.sh close pr 21077 --repo Aditya060806/Maestro --dry-run
