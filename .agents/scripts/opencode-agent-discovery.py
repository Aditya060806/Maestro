...
if not primary_agents:
    ...
    print("  Disabled 'Plan+', 'Maestro', 'Browser-Extension-Dev', 'Mobile-App-Dev' (available as @subagents)")
...
# =============================================================================
# INSTRUCTIONS - Auto-load maestro AGENTS.md for full framework context
# =============================================================================
instructions_path = os.path.expanduser("~/.maestro/agents/AGENTS.md")
if os.path.exists(instructions_path):
    config['instructions'] = [instructions_path]
    print("  Added instructions: ~/.maestro/agents/AGENTS.md (auto-loaded every session)")
else:
    print("  Warning: ~/.maestro/agents/AGENTS.md not found - run setup.sh first")
