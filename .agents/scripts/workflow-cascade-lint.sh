...
print_markdown_report() {
	...
	printf 'See: [t2220](https://github.com/Aditya060806/Maestro/pull/19726) (evidence), '
	printf '[t2228 parent](https://github.com/Aditya060806/Maestro/issues/19736) (remediation plan)\n\n'
	# shellcheck disable=SC2016
