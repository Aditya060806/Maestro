...
#
# State file:
#   ${MAESTRO_PULSE_IDLE_STATE_FILE:-~/.maestro/cache/pulse-idle-state.json}
#
# Env overrides:
#   MAESTRO_PULSE_IDLE_BASE_INTERVAL_S      (default 90, base interval)
#   MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_5  (default 5,   step-1 trigger)
#   MAESTRO_PULSE_IDLE_BACKOFF_STEP_5_S     (default 180, step-1 interval)
#   MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_10 (default 10,  step-2 trigger)
#   MAESTRO_PULSE_IDLE_BACKOFF_STEP_10_S    (default 300, step-2 interval)
#   MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_20 (default 20,  step-3 trigger)
#   MAESTRO_PULSE_IDLE_BACKOFF_STEP_20_S    (default 600, step-3 interval)
#   MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_30 (default 30,  step-4 trigger)
#   MAESTRO_PULSE_IDLE_BACKOFF_STEP_30_S    (default 1800,step-4 interval / cap)
#   MAESTRO_SKIP_PULSE_IDLE_BACKOFF         (default 0;   set to 1 to disable
#                                              all backoff — should-skip always
#                                              exits 1 / proceed)
#   MAESTRO_PULSE_IDLE_AVAILABLE_WORK       (default 0;   set to 1 when the
...
# Configuration
# -----------------------------------------------------------------------------
_PIB_BASE_INTERVAL_S="${MAESTRO_PULSE_IDLE_BASE_INTERVAL_S:-90}"
_PIB_THRESHOLD_5="${MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_5:-5}"
_PIB_STEP_5_S="${MAESTRO_PULSE_IDLE_BACKOFF_STEP_5_S:-180}"
_PIB_THRESHOLD_10="${MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_10:-10}"
_PIB_STEP_10_S="${MAESTRO_PULSE_IDLE_BACKOFF_STEP_10_S:-300}"
_PIB_THRESHOLD_20="${MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_20:-20}"
_PIB_STEP_20_S="${MAESTRO_PULSE_IDLE_BACKOFF_STEP_20_S:-600}"
_PIB_THRESHOLD_30="${MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_30:-30}"
_PIB_STEP_30_S="${MAESTRO_PULSE_IDLE_BACKOFF_STEP_30_S:-1800}"

_PIB_STATE_FILE="${MAESTRO_PULSE_IDLE_STATE_FILE:-${HOME}/.maestro/cache/pulse-idle-state.json}"
...
ENVIRONMENT (overrides for backoff schedule):
  MAESTRO_PULSE_IDLE_BASE_INTERVAL_S      (default 90)
  MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_5  (default 5)
  MAESTRO_PULSE_IDLE_BACKOFF_STEP_5_S     (default 180)
  MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_10 (default 10)
  MAESTRO_PULSE_IDLE_BACKOFF_STEP_10_S    (default 300)
  MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_20 (default 20)
  MAESTRO_PULSE_IDLE_BACKOFF_STEP_20_S    (default 600)
  MAESTRO_PULSE_IDLE_BACKOFF_THRESHOLD_30 (default 30)
  MAESTRO_PULSE_IDLE_BACKOFF_STEP_30_S    (default 1800)
  MAESTRO_SKIP_PULSE_IDLE_BACKOFF         (default 0; set 1 to disable)
  MAESTRO_PULSE_IDLE_AVAILABLE_WORK       (default 0; set 1 when eligible work exists)
  MAESTRO_PULSE_IDLE_STATE_FILE           (default ~/.maestro/cache/pulse-idle-state.json)
EOF
	return 0
}
