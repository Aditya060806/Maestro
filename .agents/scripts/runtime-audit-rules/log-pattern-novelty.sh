...
#
# Inputs (env):
#   LOG_FILE             default ~/.maestro/logs/pulse-wrapper.log
...
runtime_audit_check() {
	local log_file="${LOG_FILE:-${HOME}/.maestro/logs/pulse-wrapper.log}"
