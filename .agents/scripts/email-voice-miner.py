...
style guide stored at:
  ...
  ~/.maestro/.agent-workspace/email-intelligence/voice-profile-{account}.md
...
Usage:
  python3 email-voice-miner.py --account <name> --imap-host <host> \\
      ...
      [--sent-folder "Sent"] [--output-dir ~/.maestro/.agent-workspace/email-intelligence]
...
Part of maestro email intelligence system (t1501).
"""
...
DEFAULT_OUTPUT_DIR = Path.home() / ".maestro" / ".agent-workspace" / "email-intelligence"
