...
#
# Draft storage: ~/.maestro/.agent-workspace/draft-responses/
...
DRAFT_DIR="${HOME}/.maestro/.agent-workspace/draft-responses"
LOGFILE="${HOME}/.maestro/logs/draft-response.log"
CW_STATE="${HOME}/.maestro/cache/contribution-watch.json"
