...
WRAPPER_LOGFILE="${WRAPPER_LOGFILE:-${HOME}/.maestro/logs/pulse-wrapper.log}"
...
PULSE_WRAPPER_LOG_LAST_SIZE_FILE="${PULSE_WRAPPER_LOG_LAST_SIZE_FILE:-${HOME}/.maestro/cache/pulse-wrapper-log-last-size}"
...
_write_advisory() {
	local msg="$1"
	local advisory_dir="${HOME}/.maestro/cache"
