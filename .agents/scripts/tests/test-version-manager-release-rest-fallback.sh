...
git remote add origin 'git@github.com:Aditya060806/Maestro.git'
...
if ! grep -q 'api repos/Aditya060806/Maestro/releases --method POST' "$FAKE_GH_LOG" 2>/dev/null; then
