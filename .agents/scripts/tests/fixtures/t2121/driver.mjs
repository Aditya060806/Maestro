...
//   split   — two chunks with the split mid-"mcp__maestro__" token
//
...
const EVENT = `data: {"type":"content_block_start","content_block":{"type":"tool_use","name":"mcp__maestro__grep","input":{}}}\n`;
...
async function run() {
  ...
  if (output.includes("mcp__maestro__")) {
