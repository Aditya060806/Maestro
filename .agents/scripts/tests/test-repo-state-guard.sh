...
export MAESTRO_VERSION_FILE="${tmp_dir}/VERSION"
printf '9.9.9\n' >"$MAESTRO_VERSION_FILE"
...
printf 'external\n' >"$mode_file"
: >"$call_log"
if maestro_can_manage_repo_issue_state "other/project" "tester"; then
