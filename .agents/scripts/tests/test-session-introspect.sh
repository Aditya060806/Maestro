...
# opencode-maestro plugin, runs each subcommand, and asserts expected
...
export MAESTRO_INTROSPECT_DB="$DB"
...
MAESTRO_INTROSPECT_DB="/nonexistent/missing.db" out=$("$HELPER" recent 2>&1) && rc=0 || rc=$?
