...
assert_api_issue_fetch_count() {
	...
	local label="$2"
	local actual
	actual=$(grep -c 'repos/Aditya060806/Maestro/issues/23932$' "$GH_CALL_LOG" 2>/dev/null || true)
...
- [ ] Remaining: worker bootstrap hard-stop."
	...
	_pm_handle_partial_parent_closeout "23936" "Aditya060806/Maestro" "Merged dependency graph leaf."
...
+ [ ] Remaining: plus bullet."
	...
	_pm_handle_partial_parent_closeout "23936" "Aditya060806/Maestro" "Leaf fix."
...
- [ ] Two"
	...
	_pm_handle_partial_parent_closeout "23936" "Aditya060806/Maestro" "Leaf fix." "23932"
