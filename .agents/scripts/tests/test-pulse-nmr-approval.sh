...
test_a_stale_recovery_with_approved_pr_posts_notification() {
	...
	_notify_stale_recovery_resolved_by_pr 21699 "Aditya060806/Maestro" "2026-04-29T09:14:00Z"
	...
	if posted_comment_contains "sudo maestro approve issue 21699 Aditya060806/Maestro"; then
...
test_i_empty_nmr_timestamp_no_candidate() {
	...
	candidate=$(_find_qualifying_pr_for_stale_recovery 21699 "Aditya060806/Maestro" "")
...
test_j_ever_nmr_remediation_includes_repo_slug() {
	...
	if was_comment_posted && posted_comment_contains "sudo maestro approve issue 3733 exampleorg/examplerepo"; then
