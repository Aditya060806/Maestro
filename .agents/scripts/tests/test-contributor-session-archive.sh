...
setup() {
	...
	mkdir -p "${TEST_DIR}/home/.maestro/.agent-workspace/work/opencode-interactive/project-test/opencode"
	unset MAESTRO_WORK_DIR
	mkdir -p "${TEST_DIR}/home/.maestro/.agent-workspace/observability"
	return 0
}
...
test_session_time_includes_archive_and_dedupes() {
	...
	local wrapper_db="${TEST_DIR}/home/.maestro/.agent-workspace/work/opencode-interactive/project-test/opencode/opencode.db"
...
test_session_time_uses_observability_machine_floor() {
	...
	local active_db="${TEST_DIR}/home/.local/share/opencode/opencode.db"
	local obs_db="${TEST_DIR}/home/.maestro/.agent-workspace/observability/llm-requests.db"
	create_session_db "$active_db"
