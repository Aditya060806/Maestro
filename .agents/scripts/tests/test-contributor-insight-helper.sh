        ...
        "examples": [
          {
            ...
            "user_response": "Ran git worktree list and retried from /Users/testuser/Git/maestro"
          }
        ],
        "recovery_patterns": [
...
result=$(bash "$HELPER" sanitize "Error at /Users/Aditya060806/Git/myproject/src/main.rs:42")
assert_not_contains "home path redacted" "/Users/Aditya060806" "$result"
...
output=$(bash "$HELPER" file --dry-run "$TEST_SIGNALS" "Aditya060806/Maestro" 2>&1) || true
