...
with_clean_variant_env() {
	unset MAESTRO_HEADLESS_VARIANT || true
	unset MAESTRO_HEADLESS_VARIANT_SONNET || true
	unset MAESTRO_HEADLESS_VARIANT_OPUS || true
	unset MAESTRO_HEADLESS_WORKER_VARIANT || true
	unset MAESTRO_HEADLESS_PULSE_VARIANT || true
	return 0
}

with_clean_variant_env
MAESTRO_HEADLESS_VARIANT_SONNET="high"
...
with_clean_variant_env
MAESTRO_HEADLESS_VARIANT_OPUS="xhigh"
