...
mkdir -p "${HOME}/.maestro/logs" "${HOME}/.maestro/.agent-workspace"
...
STAMP_FILE="${HOME}/.maestro/.agent-workspace/interactive-claims/testowner-testrepo-18738.json"
...
claim_dir="${HOME}/.maestro/.agent-workspace/interactive-claims"
