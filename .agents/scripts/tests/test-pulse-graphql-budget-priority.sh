...
mkdir -p "${HOME}/.maestro/logs" "${HOME}/.maestro/cache" "${HOME}/.maestro/.agent-workspace/supervisor"
...
export MAESTRO_PULSE_OPTIONAL_BUDGET_THRESHOLD=1250
export GH_GRAPHQL_REMAINING=100
_pulse_set_graphql_budget_priority
[[ "${MAESTRO_PULSE_GRAPHQL_BUDGET_CLASS}" == "reserve" ]]
...
_pulse_set_graphql_budget_priority
[[ "${MAESTRO_PULSE_GRAPHQL_BUDGET_CLASS}" == "normal" ]]
