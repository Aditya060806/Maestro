...
test_report_aggregates_compacted_sessions() {
	create_fixture_dbs
	local _output
	_output=$(MAESTRO_REPORT_TOKEN_USE_OPENCODE_DB="${TEST_ROOT}/opencode.db" \
		MAESTRO_REPORT_TOKEN_USE_OBS_DB="${TEST_ROOT}/llm-requests.db" \
		MAESTRO_REPORT_TOKEN_USE_ROOT="${TEST_ROOT}/reports" \
		MAESTRO_REPORT_TOKEN_USE_OPENCODE_CONFIG="${TEST_ROOT}/opencode.json" \
...
SQL
	...
	MAESTRO_REPORT_TOKEN_USE_OPENCODE_DB="${TEST_ROOT}/opencode.db" \
		MAESTRO_REPORT_TOKEN_USE_OBS_DB="${TEST_ROOT}/llm-requests.db" \
		MAESTRO_REPORT_TOKEN_USE_OPENCODE_CONFIG="${TEST_ROOT}/opencode.json" \
