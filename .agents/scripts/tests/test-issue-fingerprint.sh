...
#   2. Bodies differing only in maestro sig footer → same fingerprint
...
SIG_FOOTER='<!-- maestro:sig -->
---
[maestro.sh](https://maestro.sh) v3.13.10 plugin for [OpenCode](https://opencode.ai) v1.14.29 with claude-opus-4-7 spent 9m and 9,371 tokens on this as a headless worker.'
...
<!-- maestro:sig -->
---
[maestro.sh](https://maestro.sh) v3.13.10 plugin for [OpenCode](https://opencode.ai) v1.14.29 with claude-opus-4-7 spent 12m and 15,043 tokens on this as a headless worker."
...
<!-- maestro:sig -->
---
[maestro.sh](https://maestro.sh) v3.13.10 plugin for [OpenCode](https://opencode.ai) v1.14.29 with claude-opus-4-7 spent 9m and 9,371 tokens."
