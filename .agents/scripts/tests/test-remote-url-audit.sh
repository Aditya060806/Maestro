...
#   3. writes a persistent advisory file to $HOME/.maestro/advisories/
...
mkdir -p "${TMP}/home/.config/maestro"
cat >"${TMP}/home/.config/maestro/repos.json" <<JSON
{
  "initialized_repos": [
...
advisory_dir="${TMP}/home/.maestro/advisories"
advisory_files=()
...
rm -rf "${TMP}/home2"
mkdir -p "${TMP}/home2/.config/maestro"
cat >"${TMP}/home2/.config/maestro/repos.json" <<JSON
{
  "initialized_repos": [
    {"path": "${CLEAN_REPO}", "slug": "fake-org/clean-repo"}
  ]
