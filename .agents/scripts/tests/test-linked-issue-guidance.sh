...
assert_contains ".agents/scripts/commands/log-issue-maestro.md" 'For #NNN.*Ref #NNN' "command log issue PR reference guidance"
assert_contains ".agents/workflows/log-issue-maestro.md" 'For #NNN.*Ref #NNN' "workflow log issue PR reference guidance"
