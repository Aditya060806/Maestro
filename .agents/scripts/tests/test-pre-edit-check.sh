...
test_auto_creates_git_path_worktree_from_ansi_helper_output() {
	...
	local output=""
	local exit_code=0
	output=$(FULL_LOOP_HEADLESS=true run_helper "$repo_path" --loop-mode --task "https://github.com/Aditya060806/Maestro/issues/22136" 2>&1) || exit_code=$?
