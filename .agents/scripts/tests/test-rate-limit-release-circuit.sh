...
reset_case() {
	: >"$CALL_LOG"
	printf '[]\n' >"$COMMENTS_JSON"
	unset MAESTRO_RATE_LIMIT_RELEASE_CIRCUIT_OVERRIDE 2>/dev/null || true
	export MAESTRO_RATE_LIMIT_RELEASE_CIRCUIT_THRESHOLD=3
	export MAESTRO_RATE_LIMIT_RELEASE_CIRCUIT_LOOKBACK_SECS=86400
	export MAESTRO_RATE_LIMIT_RELEASE_CIRCUIT_COOLDOWN_SECS=600
	return 0
}
