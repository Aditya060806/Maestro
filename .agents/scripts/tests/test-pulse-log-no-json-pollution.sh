...
CLEAN_LOG=$(mktemp)
printf '%s\n' '[pulse-wrapper] Dispatched worker PID 88900 for #21729 in Aditya060806/Maestro' >>"$CLEAN_LOG"
...
POLLUTED_LOG=$(mktemp)
printf '%s\n' '[pulse-wrapper] Dispatched worker PID 88900 for #21729 in Aditya060806/Maestro' >>"$POLLUTED_LOG"
