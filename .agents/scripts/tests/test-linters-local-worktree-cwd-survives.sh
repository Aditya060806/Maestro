...
WORKTREE_CLEAN_GRACE_HOURS=1 MAESTRO_NO_NETWORK=1 bash "${TEST_SCRIPTS_DIR}/worktree-helper.sh" clean --auto >/dev/null 2>&1 || fail "run cleanup from linked worktree"
