...
teardown_test_env() {
	...
	LOGFILE=""
	STAGE_LOG=""
	unset TEST_STAGE_SLEEP_ONCE MAESTRO_PULSE_ASYNC_POST_DISPATCH_HOUSEKEEPING
...
test_sync_housekeeping_runs_all_stages() {
	setup_test_env
	export MAESTRO_PULSE_ASYNC_POST_DISPATCH_HOUSEKEEPING=0
...
test_async_housekeeping_returns_before_slow_stage() {
	setup_test_env
	export MAESTRO_PULSE_ASYNC_POST_DISPATCH_HOUSEKEEPING=1
