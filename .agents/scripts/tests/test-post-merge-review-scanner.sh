...
assert_equals "SCANNER_CURSOR_DIR uses a user-isolated /tmp fallback when HOME is empty" "/tmp/.maestro-scanner-test-user/logs/post-merge-review-scanner" "$scanner_cursor_without_home"
assert_not_contains "SCANNER_CURSOR_DIR does not use shared /tmp fallback when HOME is empty" "/tmp/.maestro/logs/post-merge-review-scanner" "$scanner_cursor_without_home"
...
assert_equals "SCANNER_CURSOR_DIR uses a user-isolated /tmp fallback when HOME is unset" "/tmp/.maestro-scanner-test-user/logs/post-merge-review-scanner" "$scanner_cursor_with_unset_home"
assert_not_contains "SCANNER_CURSOR_DIR does not use shared /tmp fallback when HOME is unset" "/tmp/.maestro/logs/post-merge-review-scanner" "$scanner_cursor_with_unset_home"
