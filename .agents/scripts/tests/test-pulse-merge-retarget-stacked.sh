...
test_zero_children_noop() {
	...
	_retarget_stacked_children "100" "Aditya060806/Maestro"
...
test_provided_head_ref_context_skips_view() {
	...
	_retarget_stacked_children "100" "Aditya060806/Maestro" "feature/from-context"
	...
	if ! grep -q -- "pr list --repo Aditya060806/Maestro --base feature/from-context" "$LAST_GH_ARGS_FILE"; then
		print_result "provided headRefName context skips gh_pr_view" 1 \
