...
network_output="$(MAESTRO_REACH_TEST_FORCE_MISSING=1 "$HELPER" network doctor --format json)"
...
fingerprint_output="$(MAESTRO_REACH_TEST_FORCE_MISSING=1 "$HELPER" fingerprint doctor --format json)"
