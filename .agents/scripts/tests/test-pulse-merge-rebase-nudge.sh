...
test_nudge_body_contains_marker_and_branch() {
	...
	_post_rebase_nudge_on_interactive_conflicting "18604" "Aditya060806/Maestro"
...
test_contributor_nudge_uses_base_branch() {
	...
	_post_rebase_nudge_on_contributor_conflicting "18604" "Aditya060806/Maestro"
...
test_worker_nudge_uses_base_branch() {
	...
	_post_rebase_nudge_on_worker_conflicting "18604" "Aditya060806/Maestro" "t18025" "25780"
...
test_nudge_passes_pr_number_and_repo() {
	...
	if [[ "$LAST_NUDGE_ARGS" != *"repo=Aditya060806/Maestro"* ]]; then
		print_result "nudge passes PR number and repo slug" 1 \
			"Expected repo=Aditya060806/Maestro. Got: ${LAST_NUDGE_ARGS}"
		return 0
	fi
...
test_noops_when_idempotent_helper_undefined() {
	...
	if ! _post_rebase_nudge_on_interactive_conflicting "18604" "Aditya060806/Maestro"; then
...
test_noops_on_invalid_pr_number() {
	...
	if ! _post_rebase_nudge_on_interactive_conflicting "not-a-number" "Aditya060806/Maestro"; then
