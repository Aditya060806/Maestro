...
#   4. The `<!-- maestro:generator=... -->` marker for pre-dispatch validators
#
...
assert_contains \
	...
	"$gate_body_section" \
	"maestro:generator=large-file-simplification-gate"
...
assert_contains \
	...
	"$sweep_body_section" \
	"maestro:generator=function-complexity-sweep"
...
assert_contains \
	...
	"$sh_body_section" \
	"maestro:generator=function-complexity-gate"
...
assert_contains \
	...
	"$md_body_section" \
	"maestro:generator=agent-doc-simplification-gate"
