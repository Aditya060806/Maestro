...
gh() {
	...
	if [[ "$_api" == "api" && "$_paginate" == "--paginate" && "$_endpoint" == "repos/Aditya060806/Maestro/pulls/25324/files?per_page=100" && "$_jq_flag" == "--jq" && "$_jq_expr" == ".[].filename" ]]; then
		printf '%s\n' ".agents/scripts/vault-helper.sh" ".agents/scripts/vault-crypto-helper.py" ".agents/scripts/vault-helper.sh"
		return 0
	fi
	if [[ "$_api" == "api" && "$_paginate" == "--paginate" && "$_endpoint" == "repos/Aditya060806/Maestro/check-runs/123/annotations?per_page=100" && "$_jq_flag" == "--jq" ]]; then
  ...
  "examples": [
    {
      "source_kind": "pr",
      "source_ref": "#25324",
      "source_url": "https://github.com/Aditya060806/Maestro/pull/25324",
      "run_url": "https://github.com/Aditya060806/Maestro/runs/82536587204",
      "details_url": "https://www.codefactor.io/repository/github/Aditya060806/Maestro/pull/25324",
  ...
  "examples": [
    {
      "source_kind": "pr",
      "source_ref": "#26016",
      "source_url": "https://github.com/Aditya060806/Maestro/pull/26016",
      "run_url": "https://github.com/Aditya060806/Maestro/actions/runs/28436868573/job/84264809560",
      "details_url": "https://github.com/Aditya060806/Maestro/actions/runs/28436868573/job/84264809560",
      "affected_paths": [],
      "annotations": [],
      "conclusion": "failure"
    }
...
qlty_empty_sarif_events_json='[
  ...
  },
  {
    ...
    "source_kind": "pr",
    "source_ref": "#26015",
    "source_url": "https://github.com/Aditya060806/Maestro/pull/26015",
    "check_name": "Qlty Smell Threshold",
    "signature": "Failed to run qlty smells (empty SARIF output)",
    "run_url": "https://github.com/Aditya060806/Maestro/actions/runs/28436868573/job/84264809560",
    "details_url": "https://github.com/Aditya060806/Maestro/actions/runs/28436868573/job/84264809560",
...
paths_json=$(fetch_pr_changed_paths_json "Aditya060806/Maestro" "25324")
annotations_json=$(fetch_check_run_annotations_summary_json "Aditya060806/Maestro" "123")
GH_MODE=fail
failed_paths_json=$(fetch_pr_changed_paths_json "Aditya060806/Maestro" "25324")
failed_annotations_json=$(fetch_check_run_annotations_summary_json "Aditya060806/Maestro" "123")
GH_MODE=success
...
[
  {
    ...
    "conclusion": "failure",
    "details_url": "https://www.codefactor.io/repository/github/Aditya060806/Maestro/pull/25324",
    "html_url": "https://github.com/Aditya060806/Maestro/runs/82536587204",
  ...
  },
  {
    "name": "ShellCheck",
    "conclusion": "failure",
    "details_url": "https://github.com/Aditya060806/Maestro/actions/runs/82536587205/job/1",
    "html_url": "https://github.com/Aditya060806/Maestro/runs/82536587205",
...
event_file=$(mktemp)
process_failed_runs "$failed_runs_json" "Aditya060806/Maestro" "pr" "#25324" "https://github.com/Aditya060806/Maestro/pull/25324" \
