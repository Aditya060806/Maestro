...
export SUPERVISOR_CIRCUIT_BREAKER_REPO="Aditya060806/Maestro"
...
if [[ "\$1" == "issue" && "\$2" == "create" ]]; then
	...
	echo "https://github.com/Aditya060806/Maestro/issues/9900\$cnt"
	exit 0
fi
...
# downstream `<!-- maestro:sig -->` assertion gates.
mkdir -p "${HOME}/.maestro/agents/scripts"
cat >"${HOME}/.maestro/agents/scripts/gh-signature-helper.sh" <<'EOF'
#!/usr/bin/env bash
