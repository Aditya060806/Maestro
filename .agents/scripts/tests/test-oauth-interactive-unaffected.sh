...
cat >"$TMP/isolated/opencode/auth.json" <<'JSON'
{
  "anthropic": {
    "type": "oauth",
    "access": "PROD-access-Aditya060806-at-mac-com",
    "refresh": "PROD-refresh-Aditya060806-at-mac-com",
    "expires": 0
  }
}
JSON
...
{
  "anthropic": [
    {"email": "Aditya060806@mac.com", "access": "PROD-access-Aditya060806-at-mac-com", "cooldownUntil": ${cooldown_until}, "status": "rate_limited", "priority": 10},
...
export MAESTRO_OAUTH_POOL_FILE="$TMP/pool.json"
