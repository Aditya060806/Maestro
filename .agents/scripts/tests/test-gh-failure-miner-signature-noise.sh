...
gh() {
	...
	if [[ "$first" == "api" && "$endpoint" == "repos/Aditya060806/Maestro/actions/runs/28472942857/jobs" ]]; then
		printf '%s\n' '{"jobs":[{"id":84390104069,"conclusion":"failure","check_run_url":"https://api.github.com/repos/Aditya060806/Maestro/check-runs/84390104069","steps":[{"name":"Gate result","conclusion":"failure"}]}]}'
		return 0
	fi
...
signature=$(extract_failure_signature "Aditya060806/Maestro" "28472942857" "84390104069")
