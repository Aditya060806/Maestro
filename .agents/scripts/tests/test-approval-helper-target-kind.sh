...
run_case "PR command rejects issue target" '
	...
	_validate_approval_target_kind pr 26392 Aditya060806/Maestro
' 1
assert_contains "PR command names wrong target kind" "$LAST_OUTPUT" "#26392 in Aditya060806/Maestro is an issue, not a PR."
assert_contains "PR command advises issue approval command" "$LAST_OUTPUT" "sudo maestro approve issue 26392 Aditya060806/Maestro"
...
run_case "issue command rejects PR target" '
	...
	_validate_approval_target_kind issue 99 Aditya060806/Maestro
' 1
assert_contains "issue command names wrong target kind" "$LAST_OUTPUT" "#99 in Aditya060806/Maestro is a PR, not an issue."
assert_contains "issue command advises PR approval command" "$LAST_OUTPUT" "sudo maestro approve pr 99 Aditya060806/Maestro"
...
run_case "missing target gives check issue or PR guidance" '
	...
	_validate_approval_target_kind pr 404 Aditya060806/Maestro
' 1
...
assert_contains "missing PR target suggests issue command" "$LAST_OUTPUT" "sudo maestro approve issue 404 Aditya060806/Maestro"
...
run_case "matching issue target succeeds" '
	...
	_validate_approval_target_kind issue 123 Aditya060806/Maestro
' 0
...
run_case "matching PR target succeeds" '
	...
	_validate_approval_target_kind pr 456 Aditya060806/Maestro
' 0
