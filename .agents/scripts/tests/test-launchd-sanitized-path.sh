...
LAUNCHD_LABEL="com.test.maestro-auto-update"
LOG_FILE="${TMPDIR:-/tmp}/maestro-launchd-sanitized-path-test.log"
LAUNCHD_DIR="${TMPDIR:-/tmp}"
LAUNCHD_PLIST="${TMPDIR:-/tmp}/com.test.maestro-auto-update.plist"
SYSTEMD_SERVICE_DIR="${TMPDIR:-/tmp}"
SYSTEMD_UNIT_NAME="maestro-auto-update"
CRON_MARKER="# maestro-auto-update"
DEFAULT_INTERVAL=10
...
test_sanitized_path_filters_missing_entries() {
	...
	result=$(maestro_launchd_sanitized_path "$polluted_path")
