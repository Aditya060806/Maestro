...
PULSE_CANONICAL_RECOVERY_STATE="${HOME}/.maestro/.agent-workspace/supervisor/canonical-recovery-state.json"
...
declare -a leak_test_paths=(
	...
	"/Users/Aditya060806/Git/example-repo"
...
for raw_path in "${leak_test_paths[@]}"; do
	...
	case "$raw_path" in
		...
		/Users/*) leaked_user="/Users/Aditya060806/" ;;
