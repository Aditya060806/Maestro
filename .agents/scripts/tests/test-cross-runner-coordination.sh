...
test_claim_deferred_body_format() {
	...
	assert_eq "Aditya060806" "$extracted_runner" "runner field parseable"
...
test_close_race_detection() {
	...
	local claims='[
		...
		{"nonce":"loser","runner":"Aditya060806","created_at":"2026-04-20T10:00:02Z","created_epoch":1774468802}
	]'
