...
# `~/.config/maestro/scheduler-runtime-bin = ~/.local/bin/claude`,
...
persisted_file5="$fixture5/.config/maestro/scheduler-runtime-bin"
...
mkdir -p "$fixture6/.config/maestro"
printf '%s\n' "$claude_stub6" >"$fixture6/.config/maestro/scheduler-runtime-bin"
...
persisted6=$(cat "$fixture6/.config/maestro/scheduler-runtime-bin" 2>/dev/null || true)
...
persisted7=$(cat "$fixture7/.config/maestro/scheduler-runtime-bin" 2>/dev/null || true)
