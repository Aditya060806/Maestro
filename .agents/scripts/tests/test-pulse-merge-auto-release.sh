...
: >"$GH_CALLS"
: >"$RELEASE_CALLS"
STAMP="${CLAIM_STAMP_DIR}/Aditya060806-maestro-9901.json"
printf '{"pid":1234}\n' >"$STAMP"
GH_LABELS_RESPONSE="origin:interactive,tier:standard"

_release_interactive_claim_on_merge "42" "Aditya060806/Maestro" "9901"

if grep -q "release 9901 Aditya060806/Maestro" "$RELEASE_CALLS" 2>/dev/null; then
	...
	fail "happy path: release called for origin:interactive PR with stamp" \
		"expected 'release 9901 Aditya060806/Maestro' in release calls — got: $(cat "$RELEASE_CALLS" 2>/dev/null || printf '(empty)')"
fi
...
: >"$RELEASE_CALLS"
: >"$LOGFILE"
STAMP="${CLAIM_STAMP_DIR}/Aditya060806-maestro-9902.json"
printf '{"pid":1234}\n' >"$STAMP"
GH_LABELS_RESPONSE="origin:worker,tier:standard"

_release_interactive_claim_on_merge "43" "Aditya060806/Maestro" "9902"
...
: >"$RELEASE_CALLS"
: >"$LOGFILE"
STAMP="${CLAIM_STAMP_DIR}/Aditya060806-maestro-9903.json"
printf '{"pid":1234}\n' >"$STAMP"
GH_LABELS_RESPONSE="origin:interactive,tier:standard"

_release_interactive_claim_on_merge "44" "Aditya060806/Maestro" ""
...
MISSING_STAMP="${CLAIM_STAMP_DIR}/Aditya060806-maestro-9904.json"
rm -f "$MISSING_STAMP"
GH_LABELS_RESPONSE="origin:interactive,tier:standard"

_release_interactive_claim_on_merge "45" "Aditya060806/Maestro" "9904"
