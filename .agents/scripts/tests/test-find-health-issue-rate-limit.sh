...
#
# Production failure (2026-04-21 UTC on Aditya060806/Maestro and fleet):
...
export MAESTRO_GH_REST_FALLBACK_THRESHOLD=-1
export MAESTRO_GH_FORCE_REST_READS=0
export MAESTRO_GH_REST_FIRST_READS=0
...
CACHE_FILE="${HOME}/.maestro/logs/health-issue-alice-supervisor-owner-repo"
...
reset_stubs
state_file="${HOME}/.maestro/logs/health-dedup-last-scan-alice-supervisor-owner-repo"
