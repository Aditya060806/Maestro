...
#   3. Bypass env var (MAESTRO_SKIP_ACTIONS_QUEUE_SATURATION=1) and disable
...
_reset_env() {
	unset MAESTRO_PULSE_CIRCUIT_BREAKER_THRESHOLD
	unset MAESTRO_ACTIONS_QUEUE_SATURATION_QUEUED_MIN
	unset MAESTRO_ACTIONS_QUEUE_SATURATION_RATIO_MIN
	unset MAESTRO_SKIP_ACTIONS_QUEUE_SATURATION
	unset MAESTRO_SKIP_PULSE_CIRCUIT_BREAKER
...
out=$(_check_actions_queue_saturation "Aditya060806/Maestro")
...
out=$(_check_actions_queue_saturation "Aditya060806/Maestro"); rc=$?
...
# 3a: MAESTRO_SKIP_ACTIONS_QUEUE_SATURATION=1 short-circuits to saturated=0
# even with API responses indicating clear saturation.
_reset_env
set_shim MAESTRO_SKIP_ACTIONS_QUEUE_SATURATION=1 \
...
_reset_env
set_shim MAESTRO_ACTIONS_QUEUE_SATURATION_QUEUED_MIN=0 \
	GH_SHIM_QUEUED_TOTAL=110 GH_SHIM_IN_PROGRESS_TOTAL=3
out=$(_check_actions_queue_saturation "Aditya060806/Maestro")
...
_reset_env
set_shim MAESTRO_ACTIONS_QUEUE_SATURATION_QUEUED_MIN=5 \
	MAESTRO_ACTIONS_QUEUE_SATURATION_RATIO_MIN=2 \
...
_reset_env
set_shim MAESTRO_ACTIONS_QUEUE_SATURATION_QUEUED_MIN=200 \
	GH_SHIM_QUEUED_TOTAL=110 GH_SHIM_IN_PROGRESS_TOTAL=3
out=$(_check_actions_queue_saturation "Aditya060806/Maestro")
...
classification=$(_classify_stuck_pr "12345" "Aditya060806/Maestro" "1")
...
_reset_env
set_shim 'GH_SHIM_PR_VIEW_JSON={"labels":[],"mergeable":"MERGEABLE","statusCheckRollup":[{"name":"Maintainer Gate","status":"QUEUED","conclusion":null}]}'
classification=$(_classify_stuck_pr "12345" "Aditya060806/Maestro" "0")
...
_reset_env
set_shim 'GH_SHIM_PR_VIEW_JSON={"labels":[],"mergeable":"MERGEABLE","statusCheckRollup":[{"name":"Maintainer Gate","status":"QUEUED","conclusion":null}]}'
classification=$(_classify_stuck_pr "12345" "Aditya060806/Maestro")
