...
test_ac1_scanner_label_with_stale_recovery_breaker_preserves_nmr() {
	...
	set_timeline '[{"event":"labeled","label":{"name":"needs-maintainer-review"},"actor":{"login":"Aditya060806"},"created_at":"2026-04-24T05:07:24Z"}]'
	...
	if _nmr_applied_by_maintainer 2717 exampleorg/examplerepo Aditya060806; then
...
test_ac1_scanner_label_with_cost_breaker_preserves_nmr() {
	...
	set_timeline '[{"event":"labeled","label":{"name":"needs-maintainer-review"},"actor":{"login":"Aditya060806"},"created_at":"2026-04-24T06:00:00Z"}]'
	...
	if _nmr_applied_by_maintainer 100 Aditya060806/Maestro Aditya060806; then
...
test_ac2_scanner_label_nmr_at_creation_auto_approves() {
	...
	set_timeline '[{"event":"labeled","label":{"name":"needs-maintainer-review"},"actor":{"login":"Aditya060806"},"created_at":"2026-04-24T04:06:55Z"}]'
	set_comments '[]'
	set_issue_meta '{"labels":[{"name":"source:review-feedback"},{"name":"needs-maintainer-review"},{"name":"auto-dispatch"}],"created_at":"2026-04-24T04:06:53Z"}'

	if _nmr_applied_by_maintainer 2718 exampleorg/examplerepo Aditya060806; then
...
test_ac2_review_followup_label_nmr_at_creation_auto_approves() {
	...
	set_timeline '[{"event":"labeled","label":{"name":"needs-maintainer-review"},"actor":{"login":"Aditya060806"},"created_at":"2026-04-24T04:30:00Z"}]'
	set_comments '[]'
	set_issue_meta '{"labels":[{"name":"review-followup"},{"name":"needs-maintainer-review"}],"created_at":"2026-04-24T04:29:55Z"}'

	if _nmr_applied_by_maintainer 200 Aditya060806/Maestro Aditya060806; then
...
test_ac3_scanner_label_late_nmr_no_breaker_preserves() {
	...
	set_timeline '[{"event":"labeled","label":{"name":"needs-maintainer-review"},"actor":{"login":"Aditya060806"},"created_at":"2026-04-24T05:06:53Z"}]'
	...
	if _nmr_applied_by_maintainer 2719 exampleorg/examplerepo Aditya060806; then
...
test_ac5_no_work_loop_breaker_with_scanner_label_preserves() {
	...
	set_timeline '[{"event":"labeled","label":{"name":"needs-maintainer-review"},"actor":{"login":"Aditya060806"},"created_at":"2026-04-24T06:30:00Z"}]'
	...
	if _nmr_applied_by_maintainer 2720 exampleorg/examplerepo Aditya060806; then
...
test_order_inversion_breaker_wins_over_scanner_comment_marker() {
	...
	if _nmr_applied_by_maintainer 2721 exampleorg/examplerepo Aditya060806; then
...
test_cotemporality_at_300s_boundary_passes() {
	...
	if _nmr_application_has_automation_signature 300 Aditya060806/Maestro "2026-04-24T04:05:00Z"; then
...
test_cotemporality_at_301s_boundary_fails() {
	...
	if _nmr_application_has_automation_signature 301 Aditya060806/Maestro "2026-04-24T04:05:01Z"; then
...
test_cotemporality_missing_created_at_fails_safe() {
	...
	if _nmr_application_has_automation_signature 400 Aditya060806/Maestro "2026-04-24T04:05:00Z"; then
