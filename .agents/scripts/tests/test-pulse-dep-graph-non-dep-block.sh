...
assert_eq 'dispatch claim' 'false' \
	"$(comment_has_marker 'DISPATCH_CLAIM nonce=abc123 runner=Aditya060806 ts=2026-04-13T00:00:00Z max_age_s=1800')"
...
printf 'DISPATCH_CLAIM nonce=abc123 runner=Aditya060806\n---\nPR #1234 merged.' >"$GH_STUB_COMMENTS"
got=$(_should_defer_auto_unblock 'owner/repo' '123' 'false' || echo "__no_defer__")
