...
cmd_ralph_loop() {
	create_command "ralph-loop" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/ralph-loop.md and follow its instructions.
...
```bash
${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/linters-local.sh
```
...
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/commands/pr-loop.md and follow its instructions.
...
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/commands/postflight-loop.md and follow its instructions.
...
cmd_full_loop() {
	create_command "full-loop" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/commands/full-loop.md and follow its instructions.
