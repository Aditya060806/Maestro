...
VAULT_DEVICE_DIR="${MAESTRO_VAULT_DEVICE_DIR:-${MAESTRO_VAULT_DIR:-${HOME}/.config/maestro/vault}/devices}"
VAULT_DEVICE_REGISTRY="${MAESTRO_VAULT_DEVICE_REGISTRY:-${VAULT_DEVICE_DIR}/registry.json}"
VAULT_DEVICE_LOCAL_STATE="${MAESTRO_VAULT_DEVICE_LOCAL_STATE:-${VAULT_DEVICE_DIR}/local-state.json}"
VAULT_DEVICE_HEARTBEATS_DIR="${MAESTRO_VAULT_DEVICE_HEARTBEATS_DIR:-${VAULT_DEVICE_DIR}/heartbeats}"
VAULT_DEVICE_REVOCATION_TASKS="${MAESTRO_VAULT_DEVICE_REVOCATION_TASKS:-${VAULT_DEVICE_DIR}/revocation-tasks.jsonl}"
VAULT_DEVICE_STALE_SECONDS="${MAESTRO_VAULT_DEVICE_STALE_SECONDS:-900}"
