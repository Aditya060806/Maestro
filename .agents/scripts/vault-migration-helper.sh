...
# Migrate maestro data-plane files into encrypted Vault entries with verified rollback.
...
MIGRATION_ROOT="${MAESTRO_VAULT_MIGRATION_ROOT:-${HOME:+$HOME/.maestro/.agent-workspace}}"
MANIFEST_DIR="${MAESTRO_VAULT_MIGRATION_MANIFEST_DIR:-$(vault_storage_dir)/migration-manifests}"
MANIFEST_FILE="${MAESTRO_VAULT_MIGRATION_MANIFEST:-${MANIFEST_DIR}/maestro-data-migration.tsv}"
