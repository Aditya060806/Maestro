...
#
# Source: ${MAESTRO_DIR:-$HOME/.maestro}/agents/
...
discover_commands() {
	local commands_dir="${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/commands"
...
print_summary() {
	...
	echo "    /setup-maestro   - Deploy latest agent changes locally"
