...
HISTORY_DIR="${HOME}/.maestro/.agent-workspace/observability"
HISTORY_FILE="${HISTORY_DIR}/screen-time.jsonl"
OS_TYPE="${MAESTRO_SCREEN_TIME_OS_TYPE:-$(uname -s)}"

# macOS-specific paths
KNOWLEDGE_DB="${MAESTRO_KNOWLEDGE_DB:-${HOME}/Library/Application Support/Knowledge/knowledgeC.db}"
