...
DEPENDABOT_ALERT_MONITOR_STATE_DIR="${DEPENDABOT_ALERT_MONITOR_STATE_DIR:-${HOME}/.maestro/cache/dependabot-alert-monitor}"
DEPENDABOT_ALERT_MONITOR_REPOS_JSON="${DEPENDABOT_ALERT_MONITOR_REPOS_JSON:-${MAESTRO_REPOS_JSON:-${HOME}/.config/maestro/repos.json}}"
