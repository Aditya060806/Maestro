...
#
# Config: ~/.maestro/agents/configs/upstream-watch.json (template committed)
# State:  ~/.maestro/cache/upstream-watch-state.json (runtime, gitignored)
# Log:    ~/.maestro/logs/upstream-watch.log
#
...
STATE_FILE="${HOME}/.maestro/cache/upstream-watch-state.json"
LOGFILE="${HOME}/.maestro/logs/upstream-watch.log"
...
CONFIG:
    Watchlist: ~/.maestro/agents/configs/upstream-watch.json
    State:     ~/.maestro/cache/upstream-watch-state.json
    Log:       ~/.maestro/logs/upstream-watch.log
