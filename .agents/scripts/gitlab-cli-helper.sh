...
EXAMPLES:
  $0 list-projects Aditya060806
  $0 create-project Aditya060806 new-project "My GitLab project" private true
  $0 list-issues Aditya060806 my-project opened
  $0 create-issue Aditya060806 my-project "Bug report" "Issue description"
  $0 create-mr Aditya060806 my-project "Fix feature" fix-branch main
