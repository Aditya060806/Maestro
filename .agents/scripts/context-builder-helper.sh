...
readonly DEFAULT_OUTPUT_DIR="$HOME/.maestro/.agent-workspace/work/context"
...
EXAMPLES:
  ...
  # Analyze token usage
  context-builder-helper.sh analyze ~/git/maestro 50
...
OUTPUT:
  Files are saved to: ~/.maestro/.agent-workspace/work/context/
...
For more information:
  ...
  https://github.com/Aditya060806/Maestro
