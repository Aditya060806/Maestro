...
setup_beads() {
	...
	print_info "After installation, run: maestro init beads"
...
setup_beads_ui() {
	...
	echo ""
	print_info "Beads UI documentation: ~/.maestro/agents/tools/task-management/beads.md"
...
setup_safety_hooks() {
	...
	local helper_script="$HOME/.maestro/agents/scripts/install-hooks-helper.sh"
