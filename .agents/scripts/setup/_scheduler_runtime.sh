...
_ensure_cron_path() {
	local current_crontab marker="# maestro-path"
...
PATH=${deduped_path}"
	...
	# Remove only the maestro-managed marker + PATH pair.
...
#       arg8=systemd_unit (optional — base name without .timer suffix, e.g. "maestro-supervisor-pulse")
