...
CONFIG_PATH="${MATTERBRIDGE_CONFIG:-$HOME/.config/maestro/matterbridge.toml}"
DATA_DIR="$HOME/.maestro/.agent-workspace/matterbridge"
...
#   maestro secret set MATTERBRIDGE_MATRIX_PASSWORD
#   maestro secret set MATTERBRIDGE_DISCORD_TOKEN
...
Config: ~/.config/maestro/matterbridge.toml (override: MATTERBRIDGE_CONFIG)
