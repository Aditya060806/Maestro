...
#
# Environment:
#   AUDIT_LOG_DIR    Override log directory (default: ~/.maestro/.agent-workspace/observability)
...
readonly AUDIT_LOG_DIR_DEFAULT="${HOME}/.maestro/.agent-workspace/observability"
...
cmd_log() {
	...
	actor="${MAESTRO_SESSION_ID:-${USER:-unknown}}"
