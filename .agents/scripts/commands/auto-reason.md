...
Allowed forms include maestro tiers (`haiku`, `sonnet`, `opus`) and provider-qualified IDs (`openai/...`, `anthropic/...`, `google/...`, `openrouter/...`, `local/...`).
...
The subagent writes artifacts under `~/.maestro/.agent-workspace/work/auto-reason/{slug}/` unless the program overrides `output_dir:`.
...
Judges: haiku, sonnet, openai/gpt-5.5
Artifacts: ~/.maestro/.agent-workspace/work/auto-reason/{slug}/summary.md
```
