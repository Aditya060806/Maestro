---
description: Manage maestro Vault setup, lock state, encrypted sync, fleet trust, and protected-data dispatch metadata
agent: Vault
mode: subagent
---
...
Use this command guide for `maestro vault` and Vault-related `maestro fleet`
