...
| Private workflow review | `/auto-browse --review ~/.maestro/.agent-workspace/auto-browse/<id>` | Inspect an existing private run folder and recommend next action |
...
- Store account/site/client-specific workflows, cookies, storage state, downloads, and generated private agents under private maestro user data, not repo `todo/`.
