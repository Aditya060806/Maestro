...
#   ~/.maestro/.agent-workspace/security/session-context.json
#
# Usage:
...
readonly SESSION_SECURITY_BASE_DIR="${SESSION_SECURITY_DIR:-${HOME}/.maestro/.agent-workspace/security}"
...
Examples:
  ...
  session-security-helper.sh record-signal sensitive-file HIGH \
    "Accessed ~/.config/maestro/credentials.sh" --session-id worker-abc123
