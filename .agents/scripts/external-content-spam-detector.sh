...
#
# Canonical incident: Aditya060806/Maestro#20978 — "responsible disclosure"
...
#
# Pattern matching alone is insufficient — `pip install maestro` in a
...
# evidence-styled refs). Verified against Aditya060806/Maestro issue history:
...
EXAMPLES:
  ...
  external-content-spam-detector.sh check issue 20978 --repo Aditya060806/Maestro

  # JSON breakdown for programmatic use:
  external-content-spam-detector.sh score issue 20978 --repo Aditya060806/Maestro --json

  # Sweep a triage queue:
  external-content-spam-detector.sh batch --repo Aditya060806/Maestro \
