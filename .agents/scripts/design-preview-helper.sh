...
#
# Screenshots respect the maestro screenshot size limit (max 1568px longest side
...
main() {
	...
	generate | g)
		...
		print_info "  ~/.maestro/agents/tools/design/library/_template/preview.html.template"
