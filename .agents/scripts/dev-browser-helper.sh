...
readonly DEV_BROWSER_DIR="${HOME}/.maestro/dev-browser"
...
BROWSER PROFILE:
    ...
    Location: ~/.maestro/dev-browser/skills/dev-browser/profiles/browser-data/
...
DOCUMENTATION:
    See: ~/.maestro/agents/tools/browser/dev-browser.md
