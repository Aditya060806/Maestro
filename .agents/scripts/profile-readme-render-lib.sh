...
_generate_work_with_ai_table() {
	...
	local history_file="${HOME}/.maestro/.agent-workspace/observability/screen-time.jsonl"
...
_Stats will appear here automatically once [maestro](https://maestro.sh) has been running locally. Includes AI session hours, model usage, token costs, and screen time._
EOF
		return 0
	fi
