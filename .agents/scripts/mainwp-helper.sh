...
CONFIG_FILE="${HOME}/.config/maestro/mainwp-config.json"
TEMPLATE_FILE="${HOME}/.maestro/agents/configs/mainwp-config.json.txt"
...
load_config() {
	if [[ ! -f "$CONFIG_FILE" ]]; then
		...
		print_info "  mkdir -p ~/.config/maestro"
...
Configuration:
  Config file: ~/.config/maestro/mainwp-config.json
  Template: ~/.maestro/agents/configs/mainwp-config.json.txt

Setup:
  mkdir -p ~/.config/maestro
  cp ~/.maestro/agents/configs/mainwp-config.json.txt ~/.config/maestro/mainwp-config.json
