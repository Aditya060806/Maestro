...
# OCR Receipt/Invoice Extraction Helper for Maestro Framework
...
readonly WORKSPACE_DIR="${HOME}/.maestro/.agent-workspace/work/ocr-receipts"
readonly VENV_DIR="${HOME}/.maestro/.agent-workspace/python-env/document-extraction"
...
# Show help
cmd_help() {
	echo "OCR Receipt/Invoice Extraction Helper - Maestro Framework"
	echo ""
