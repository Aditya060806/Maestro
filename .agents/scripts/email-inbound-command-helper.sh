...
readonly CONFIG_FILE_DEFAULT="${HOME}/.config/maestro/email-inbound-commands.conf"
readonly STATE_DIR_DEFAULT="${HOME}/.maestro/.agent-workspace/email-inbound-commands"
readonly PROCESSED_IDS_FILE="processed-message-ids.txt"
readonly MAX_BODY_CHARS=12000
readonly MAX_DESCRIPTION_CHARS=1200
readonly RECORD_DELIMITER="<<<MAESTRO_RECORD_END>>>"
...
CONFIG_FILE="${MAESTRO_EMAIL_INBOUND_CONFIG:-$CONFIG_FILE_DEFAULT}"
STATE_DIR="${MAESTRO_EMAIL_INBOUND_STATE_DIR:-$STATE_DIR_DEFAULT}"
PROCESSED_FILE=""
...
Config:
  ~/.config/maestro/email-inbound-commands.conf
