...
#   MCP_AUDIT_LOG_DIR       Log directory (default: ~/.maestro/logs/mcp-audit)
...
MCP_AUDIT_LOG_DIR="${MCP_AUDIT_LOG_DIR:-${HOME}/.maestro/logs/mcp-audit}"
