...
#   CONTENT_CLASSIFIER_CACHE_DIR   Cache directory (default: ~/.maestro/.agent-workspace/cache/content-classifier)
...
CONTENT_CLASSIFIER_CACHE_DIR="${CONTENT_CLASSIFIER_CACHE_DIR:-${HOME}/.maestro/.agent-workspace/cache/content-classifier}"
