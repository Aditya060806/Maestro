...
SUBAGENT_DIRS="maestro content seo tools services workflows memory custom draft"
...
generate_plugin_agents_block() {
	...
	MAESTRO_AGENTS_DIR="$agents_dir" "$plugin_loader" index 2>/dev/null || true
	return 0
}
