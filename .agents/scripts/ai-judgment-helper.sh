...
# ai-judgment-helper.sh - Intelligent threshold replacement for maestro
...
# Configuration
readonly JUDGMENT_MEMORY_BASE_DIR="${MAESTRO_MEMORY_DIR:-$HOME/.maestro/.agent-workspace/memory}"
