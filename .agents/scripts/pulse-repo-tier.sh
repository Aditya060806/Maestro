...
#
# Cache:
#   ~/.maestro/cache/pulse-repo-tiers.json
...
PULSE_TIER_CACHE_FILE="${PULSE_TIER_CACHE_FILE:-${HOME}/.maestro/cache/pulse-repo-tiers.json}"
...
Environment:
  REPOS_JSON                   Path to repos.json (default: ~/.config/maestro/repos.json)
  PULSE_TIER_CACHE_FILE        Cache output path (default: ~/.maestro/cache/pulse-repo-tiers.json)
