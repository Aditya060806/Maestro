...
readonly CONFIG_FILE="${HOME}/.config/maestro/gsc-config.json"
readonly WORK_DIR="${HOME}/.maestro/.agent-workspace/tmp"
readonly GSC_SCRIPT="${WORK_DIR}/gsc-sitemap-submit.js"
# These may be overridden by load_config() — do not declare readonly
CHROME_PROFILE="${HOME}/.maestro/.agent-workspace/chrome-gsc-profile"
SCREENSHOT_DIR="${HOME}/.maestro/.agent-workspace/gsc-screenshots"
