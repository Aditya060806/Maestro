...
#   PROMPT_GUARD_LOG_DIR         Log directory (default: ~/.maestro/logs/prompt-guard)
...
# Log directory
PROMPT_GUARD_LOG_DIR="${PROMPT_GUARD_LOG_DIR:-${HOME}/.maestro/logs/prompt-guard}"

# Quiet mode
PROMPT_GUARD_QUIET="${PROMPT_GUARD_QUIET:-false}"

# YAML patterns file (auto-detect from script location or ~/.maestro)
