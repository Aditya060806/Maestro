...
readonly CACHE_DIR="${TECH_STACK_CACHE_DIR:-${HOME}/.maestro/.agent-workspace/work/tech-stack}"
...
readonly REPORTS_DIR="${HOME}/.maestro/.agent-workspace/work/tech-stack/reports"
...
CACHE:
    Results are cached in SQLite at:
      ~/.maestro/.agent-workspace/work/tech-stack/cache.db
