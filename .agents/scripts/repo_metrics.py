...
.github/badges/loc-languages.svg for existing maestro-managed README blocks.
"""
...
def build_metrics(root: Path, paths: list[Path], excludes: list[str], top_n: int) -> dict[str, Any]:
    ...
    return {
        "schema": "maestro.repo-metrics.v1",
        "schema_version": 1,
        "generated_at": generated_at,
        "tool": {"name": "maestro repo-metrics", "version": TOOL_VERSION},
