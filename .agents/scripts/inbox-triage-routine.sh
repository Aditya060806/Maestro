...
# or invoked directly via: maestro inbox triage
#
# Usage:
...
readonly TRIAGE_LOCKFILE="${TMPDIR:-/tmp}/maestro-inbox-triage.lock"
readonly TRIAGE_STAMP_FILE="${TMPDIR:-/tmp}/maestro-inbox-triage.last"
