...
#
# Configuration: ~/.config/maestro/cron-jobs.json
# Logs: ~/.maestro/.agent-workspace/cron/
#
# Security:
...
readonly WORKSPACE_DIR="$HOME/.maestro/.agent-workspace"
readonly CRON_LOG_DIR="$WORKSPACE_DIR/cron"
readonly SCRIPTS_DIR="$HOME/.maestro/agents/scripts"
...
CONFIGURATION:
    Jobs: ~/.config/maestro/cron-jobs.json
    Logs: ~/.maestro/.agent-workspace/cron/
