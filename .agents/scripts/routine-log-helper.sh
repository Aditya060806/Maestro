...
#
# State file: ~/.maestro/.agent-workspace/cron/<routine-id>/routine-state.json
# Local logs: ~/.maestro/.agent-workspace/cron/<routine-id>/
...
CRON_BASE="${HOME}/.maestro/.agent-workspace/cron"
...
**Detailed logs**: \`~/.maestro/.agent-workspace/cron/${routine_id}/\`
EOF
...
State:
  Local logs:  ~/.maestro/.agent-workspace/cron/<routine-id>/logs/executions.jsonl
  State file:  ~/.maestro/.agent-workspace/cron/<routine-id>/routine-state.json
HELP
	return 0
}
