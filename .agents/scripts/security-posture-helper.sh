...
#   security-posture-helper.sh store [repo-path]     # Run checks and store in .maestro.json
...
#
# t1412.6:  https://github.com/Aditya060806/Maestro/issues/3078
# t1412.11: https://github.com/Aditya060806/Maestro/issues/3087
...
# Paths
readonly AGENTS_DIR="${MAESTRO_AGENTS_DIR:-$HOME/.maestro/agents}"
...
Per-repo audit commands:
  ...
  store [path]         Run checks and store results in .maestro.json
...
Examples:
  ...
  $(basename "$0") store                    # Audit and store in .maestro.json
