...
INTEGRATION:
    ...
    pr-salvage-helper.sh prefetch Aditya060806/Maestro ~/Git/maestro

    # Manual scan
    pr-salvage-helper.sh scan --repo Aditya060806/Maestro --days 14

    # Exact PR salvage triage
    pr-salvage-helper.sh scan --repo Aditya060806/Maestro 23745 23695 23682
