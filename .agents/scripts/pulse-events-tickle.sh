...
#
# ETag cache: ~/.maestro/cache/pulse-events-etag/{owner}.json
...
#     ~/.maestro/agents/scripts/pulse-events-tickle.sh Aditya060806
#
...
_EVENTS_TICKLE_CACHE_DIR="${HOME}/.maestro/cache/pulse-events-etag"
...
_EVENTS_TICKLE_LOGFILE="${LOGFILE:-${HOME}/.maestro/logs/pulse-wrapper.log}"
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
	...
	if [ "${MAESTRO_BASH_REEXECED:-}" != "1" ]; then
		_cli_modern_bash=""
