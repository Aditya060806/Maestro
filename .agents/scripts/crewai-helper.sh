...
# Configuration
CREWAI_DIR="$HOME/.maestro/crewai"
CREWAI_STUDIO_PORT="${CREWAI_STUDIO_PORT:-8501}"
SCRIPTS_DIR="$HOME/.maestro/scripts"
...
setup_crewai() {
	...
	if [[ ! -f ".env.example" ]]; then
		cat >.env.example <<'EOF'
# CrewAI Configuration for Maestro Framework
...
st.markdown("*Maestro Framework - Multi-Agent Orchestration*")
...
# Footer
st.markdown("---")
st.markdown("*Part of the [Maestro Framework](https://github.com/Aditya060806/Maestro)*")
TABSEOF
	return 0
}
...
#!/bin/bash
# Maestro Framework - CrewAI Studio Startup Script
...
#!/bin/bash
# Maestro Framework - CrewAI Studio Stop Script
...
#!/bin/bash
# Maestro Framework - CrewAI Status Script
...
# Show usage
show_usage() {
	echo "Maestro Framework - CrewAI Helper"
	echo ""
