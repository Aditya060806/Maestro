...
BODY
	...
	create_command "version-bump" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/version-bump.md and follow its instructions.
...
BODY
	...
	create_command "changelog" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/changelog.md and follow its instructions.
...
define_branch_commands() {
	create_command "feature" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/branch/feature.md and follow its instructions.
...
BODY
	...
	create_command "bugfix" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/branch/bugfix.md and follow its instructions.
...
BODY
	...
	create_command "hotfix" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/branch/hotfix.md and follow its instructions.
