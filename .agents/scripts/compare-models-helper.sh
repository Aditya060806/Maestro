...
readonly PATTERN_DB="${MAESTRO_MEMORY_DIR:-$HOME/.maestro/.agent-workspace/memory}/memory.db"
...
# Map a model_id to its maestro tier for pattern lookup
...
# =============================================================================
# maestro Tier Mapping
# =============================================================================
# Maps maestro internal tiers to recommended models
