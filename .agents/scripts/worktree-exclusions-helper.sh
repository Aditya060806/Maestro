...
REPOS_JSON="${MAESTRO_REPOS_JSON:-${HOME}/.config/maestro/repos.json}"
...
Rationale: maestro worktrees are ephemeral working copies. Their persistent
...
Environment:
  MAESTRO_REPOS_JSON  Override path to repos.json (default: ~/.config/maestro/repos.json)
EOF
	return 0
}
