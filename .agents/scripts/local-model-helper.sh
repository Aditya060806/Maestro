...
# Local Model Helper - llama.cpp inference management for maestro
...
#   - Usage tracked in SQLite at ~/.maestro/.agent-workspace/memory/local-models.db
...
readonly LOCAL_MODELS_DIR="${HOME}/.maestro/local-models"
...
readonly LOCAL_MODELS_DB_DIR="${HOME}/.maestro/.agent-workspace/memory"
