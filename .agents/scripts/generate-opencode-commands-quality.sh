...
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/tools/build-agent/agent-review.md and follow its instructions.
...
BODY
	...
	create_command "review-issue-pr" \
		...
		"$AGENT_BUILD" "true" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/review-issue-pr.md and follow its instructions.
...
BODY
	...
	create_command "code-standards" \
		...
		"$AGENT_BUILD" "true" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/tools/code-review/code-standards.md and follow its instructions.
...
BODY
	...
	create_command "code-simplifier" \
		...
		"$AGENT_BUILD" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/tools/code-review/code-simplifier.md and follow its instructions.
...
define_check_commands() {
	create_command "preflight" \
		...
		"$AGENT_BUILD" "true" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/preflight.md and follow its instructions.
...
!`${MAESTRO_DIR:-$HOME/.maestro}/agents/scripts/linters-local.sh $ARGUMENTS`
...
BODY
	...
	create_command "code-audit-remote" \
		...
		"$AGENT_BUILD" "true" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/workflows/code-audit-remote.md and follow its instructions.
