...
# Mission files live in {repo}/todo/missions/{id}/mission.md or ~/.maestro/missions/{id}/mission.md.
...
**Validation criteria:** Re-run milestone validation after fix to confirm resolution."
				...
				local mv_sig=""
				mv_sig=$("${HOME}/.maestro/agents/scripts/gh-signature-helper.sh" footer --body "$issue_body" 2>/dev/null || true)
