...
readonly DEFAULT_RESOURCE_METRICS_FILE="${HOME}/.maestro/logs/resource-metrics.jsonl"
readonly DEFAULT_SAMPLE_INTERVAL_SECONDS="${MAESTRO_RESOURCE_SAMPLE_INTERVAL_SECONDS:-30}"
