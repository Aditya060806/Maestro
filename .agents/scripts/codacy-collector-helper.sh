...
readonly AUDIT_DATA_DIR="${HOME}/.maestro/.agent-workspace/work/code-audit"
...
codacy_api_request() {
	...
	local http_code=""
	local tmp_response
	local tmp_dir="${HOME}/.maestro/.agent-workspace/tmp"
...
DATABASE:
  SQLite database at: ~/.maestro/.agent-workspace/work/code-audit/audit.db
