...
#
# Scheduling:
#   Invoked daily at 05:00 by sh.maestro.efficiency-analysis launchd job.
#   On Linux, add to crontab: 0 5 * * * $HOME/.maestro/agents/scripts/efficiency-analysis-runner.sh
#
# Exit codes:
...
readonly ANALYSIS_AGENT="${HOME}/.maestro/agents/maestro/orchestration-analysis.md"
