...
readonly TOKEN_DIR="${HOME}/.maestro/.agent-workspace/tokens"
...
# Config: ~/.config/maestro/github-app.json
#   {
#     "app_id": "123456",
#     "private_key_path": "~/.config/maestro/github-app-key.pem",
...
Token strategies (tried in order):
  1. GitHub App installation token
     ...
     - Requires: GitHub App installed, config at ~/.config/maestro/github-app.json
  2. Delegated token
...
Setup for GitHub App (recommended):
  1. Create a GitHub App at https://github.com/settings/apps/new
     - Name: maestro-worker (or similar)
  ...
  5. Configure:
     ...
     cat > ~/.config/maestro/github-app.json << EOF
     {
       "app_id": "YOUR_APP_ID",
       "private_key_path": "~/.config/maestro/github-app-key.pem",
     ...
     EOF
     chmod 600 ~/.config/maestro/github-app.json
     chmod 600 ~/.config/maestro/github-app-key.pem
