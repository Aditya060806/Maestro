...
# Configuration
LANGFLOW_DIR="$HOME/.maestro/langflow"
...
setup_langflow() {
	...
	if [[ ! -f ".env.example" ]]; then
		cat >.env.example <<'EOF'
# Langflow Configuration for Maestro Framework
...
#!/bin/bash
# Maestro Framework - Langflow Startup Script
...
#!/bin/bash
# Maestro Framework - Langflow Stop Script
...
#!/bin/bash
# Maestro Framework - Langflow Status Script
...
# Show usage
show_usage() {
	echo "Maestro Framework - Langflow Helper"
	echo ""
	...
	echo "  export    Export flows to JSON (default: ~/.maestro/langflow/flows/)"
	echo "  import    Import flows from JSON (default: ~/.maestro/langflow/flows/)"
