...
# Credentials: maestro secret set AWS_ACCESS_KEY_ID / AWS_SECRET_ACCESS_KEY
#
# Part of maestro mission system (t1360)
...
readonly WORKSPACE_DIR="${EMAIL_AGENT_WORKSPACE:-${HOME}/.maestro/.agent-workspace/email-agent}"
