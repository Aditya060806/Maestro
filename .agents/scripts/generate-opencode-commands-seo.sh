...
define_keyword_research_commands() {
	create_command "keyword-research" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/keyword-research.md and follow its instructions.
...
define_seo_optimization_commands() {
	create_command "seo-fanout" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/query-fanout-research.md and follow its instructions.
...
BODY
	...
	create_command "seo-geo" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/geo-strategy.md and follow its instructions.
...
BODY
	...
	create_command "seo-sro" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/sro-grounding.md and follow its instructions.
...
define_seo_integrity_commands() {
	create_command "seo-hallucination-defense" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/ai-hallucination-defense.md and follow its instructions.
...
BODY
	...
	create_command "seo-agent-discovery" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/ai-agent-discovery.md and follow its instructions.
...
BODY
	...
	create_command "seo-ai-readiness" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/ai-search-readiness.md and follow its instructions.
...
BODY
	...
	create_command "seo-ai-baseline" \
		...
		"$AGENT_SEO" "" <<'BODY'
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/ai-search-readiness.md and follow its instructions.
Read ${MAESTRO_DIR:-$HOME/.maestro}/agents/seo/ai-search-kpi-template.md and follow its format.
