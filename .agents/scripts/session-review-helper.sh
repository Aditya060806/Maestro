...
readonly OBS_DIR="${HOME}/.maestro/.agent-workspace/observability"
readonly OBS_METRICS="${OBS_DIR}/metrics.jsonl"
readonly OBS_DB="${OBS_DIR}/llm-requests.db"
readonly AUDIT_LOG="${OBS_DIR}/audit.jsonl"
readonly NET_ACCESS_LOG="${HOME}/.maestro/.agent-workspace/network/access.jsonl"
readonly NET_FLAGGED_LOG="${HOME}/.maestro/.agent-workspace/network/flagged.jsonl"
readonly NET_DENIED_LOG="${HOME}/.maestro/.agent-workspace/network/denied.jsonl"
readonly PG_ATTEMPTS_LOG="${HOME}/.maestro/logs/prompt-guard/attempts.jsonl"
readonly SESSION_CONTEXT_FILE="${HOME}/.maestro/.agent-workspace/security/session-context.json"
readonly QUARANTINE_LOG="${HOME}/.maestro/.agent-workspace/security/quarantine.jsonl"
