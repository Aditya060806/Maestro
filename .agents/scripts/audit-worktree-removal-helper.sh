...
#
# Environment:
#   MAESTRO_CLEANUP_LOG — override log file path (default: ~/.maestro/logs/cleanup_worktrees.log)
#
...
#
# Output format (append to MAESTRO_CLEANUP_LOG):
...
log_worktree_removal_event() {
	...
	local context="${6:-}"
	local log_file="${MAESTRO_CLEANUP_LOG:-${HOME}/.maestro/logs/cleanup_worktrees.log}"
