...
# PaddleOCR Helper - Scene text / screenshot OCR for maestro
...
#   --venv PATH       Custom virtualenv path (default: ~/.maestro/paddleocr/venv)
#
# Exit codes:
#   0 - Success
#   1 - General error
...
readonly PADDLEOCR_DIR="${HOME}/.maestro/paddleocr"
