...
WORK_DIR="${HOME}/.maestro/.agent-workspace/tmp"
...
Examples:
  gsc-add-user-helper.sh add maestro@project.iam.gserviceaccount.com
  gsc-add-user-helper.sh add maestro@project.iam.gserviceaccount.com --exclude synel.co.uk
  gsc-add-user-helper.sh list
  gsc-add-user-helper.sh check maestro@project.iam.gserviceaccount.com
