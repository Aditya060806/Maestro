...
# Storage: mission.md files in todo/missions/ or ~/.maestro/missions/
...
readonly MISSIONS_HOME="${HOME}/.maestro/missions"
readonly DASHBOARD_HTML_DIR="${HOME}/.maestro/.agent-workspace/tmp"
readonly OBS_METRICS="${HOME}/.maestro/.agent-workspace/observability/metrics.jsonl"
readonly COST_LOG="${HOME}/.maestro/.agent-workspace/cost-log.tsv"
