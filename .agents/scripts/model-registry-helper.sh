...
#
# Runs on: maestro update, optionally via cron
# Storage: ~/.maestro/.agent-workspace/model-registry.db
#
...
readonly REGISTRY_DIR="${HOME}/.maestro/.agent-workspace"
...
cmd_help() {
	...
	echo ""
	echo "Integration:"
	echo "  - Runs automatically on 'maestro update'"
