...
commit_version_changes() {
	...
	git add VERSION package.json README.md setup.sh maestro.sh sonar-project.properties CHANGELOG.md TODO.md homebrew/maestro.rb .claude-plugin/marketplace.json 2>/dev/null
