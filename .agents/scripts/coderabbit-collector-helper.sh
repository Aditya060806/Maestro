...
readonly COLLECTOR_DATA_DIR="${HOME}/.maestro/.agent-workspace/work/coderabbit-reviews"
...
DATABASE:
  SQLite database at: ~/.maestro/.agent-workspace/work/coderabbit-reviews/reviews.db
  Tables: collection_runs, reviews, comments
  Direct query: sqlite3 ~/.maestro/.agent-workspace/work/coderabbit-reviews/reviews.db "SELECT ..."
