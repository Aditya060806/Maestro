...
#
# Part of maestro email system (t1518)
...
readonly WORKSPACE_DIR="${THUNDERBIRD_WORKSPACE:-${HOME}/.maestro/.agent-workspace/thunderbird}"
...
<!-- Generated by maestro thunderbird-helper.sh (t1518) -->
...
USAGE
  ...
  IMAP_PASSWORD="$(gopass show -o mail/user)" \
    thunderbird-helper.sh deploy-sieve \
      ...
      --script ~/.maestro/sieve/sort-rules.sieve
