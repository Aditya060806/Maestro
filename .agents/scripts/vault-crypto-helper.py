...
"""CLI entrypoint for local maestro Vault crypto and broker operations."""
...
def cmd_init(args: argparse.Namespace) -> int:
    ...
    print("Use a trusted password manager with backups. Maestro cannot recover it.", file=sys.stderr)
    prompt_acknowledgement()
...
def _archive_and_start_fresh() -> int:
    ...
    readme.write_text(
        "Encrypted maestro Vault archive. No passphrase or recovery secret is stored here. "
