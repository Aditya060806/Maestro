...
# Email Contact Sync Helper for Maestro Framework
...
readonly DEFAULT_CONTACTS_DIR="${HOME}/.maestro/.agent-workspace/contacts"
...
show_help() {
	cat <<'HELP'
Email Contact Sync Helper - Maestro Framework
...
Options:
  ...
  --contacts-dir <dir>  TOON contacts directory (default: ~/.maestro/.agent-workspace/contacts)
...
Examples:
  ...
  email-contact-sync-helper.sh sync-all ~/.maestro/.agent-workspace/contacts
