...
# beads-sync-helper.sh - Bi-directional sync between maestro TODO.md and Beads
...
#
# Commands:
#   push      Sync TODO.md → Beads (maestro is source of truth)
...
For more information: https://maestro.sh
EOF
}
