...
// Part of Maestro Framework (t1359)
//
...
function browserExecutablePath() {
  if (process.env.MAESTRO_PLAYWRIGHT_EXECUTABLE) return process.env.MAESTRO_PLAYWRIGHT_EXECUTABLE;
  if (process.env.MAESTRO_PLAYWRIGHT_BROWSER === 'chromium') return undefined;
