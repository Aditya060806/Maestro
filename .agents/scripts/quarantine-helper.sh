...
#
# Queue files:
#   ~/.maestro/.agent-workspace/security/quarantine/pending.jsonl   — Items awaiting review
#   ~/.maestro/.agent-workspace/security/quarantine/reviewed.jsonl  — Reviewed items with decisions
#
# Usage:
...
readonly QUARANTINE_DIR="${HOME}/.maestro/.agent-workspace/security/quarantine"
...
readonly NET_TIER_USER_CONF="${HOME}/.config/maestro/network-tiers-custom.conf"
readonly PROMPT_GUARD_CUSTOM="${HOME}/.config/maestro/prompt-guard-custom.txt"
readonly MCP_TRUSTED_LIST="${HOME}/.config/maestro/mcp-trusted-servers.txt"
...
Queue files:
  Pending:  ~/.maestro/.agent-workspace/security/quarantine/pending.jsonl
  Reviewed: ~/.maestro/.agent-workspace/security/quarantine/reviewed.jsonl

Config files written by learn:
  Network tiers: ~/.config/maestro/network-tiers-custom.conf
  Prompt guard:  ~/.config/maestro/prompt-guard-custom.txt
  MCP trusted:   ~/.config/maestro/mcp-trusted-servers.txt
