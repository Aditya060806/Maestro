...
#
# Writes one NDJSON event per invocation to ~/.maestro/logs/gh-audit.log.
...
readonly GH_AUDIT_LOG_DIR_DEFAULT="${HOME}/.maestro/logs"
...
Log path: ~/.maestro/logs/gh-audit.log
Docs:     reference/gh-audit-log.md
HELP
	return 0
}
