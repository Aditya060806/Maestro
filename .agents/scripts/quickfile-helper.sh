...
# QuickFile Integration Helper for Maestro Framework
...
# Constants
readonly QF_WORKSPACE="${HOME}/.maestro/.agent-workspace/work/quickfile"
readonly OCR_WORKSPACE="${HOME}/.maestro/.agent-workspace/work/ocr-receipts"
...
cmd_status() {
	...
	if [[ -f "${QF_MCP_DIR}/dist/index.js" ]]; then
		...
		echo "  Install: mkdir -p ~/Git/mcp && git clone https://github.com/Aditya060806/quickfile-mcp.git ~/Git/mcp/quickfile-mcp"
...
# Show help
cmd_help() {
	echo "QuickFile Integration Helper - Maestro Framework"
	echo ""
	...
	echo "  quickfile-helper.sh batch-record ~/.maestro/.agent-workspace/work/ocr-receipts/"
