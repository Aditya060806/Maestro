...
# =============================================================================
# Extracts embedded prompts from the OpenCode binary for use by maestro agents.
# This ensures our agents stay in sync with OpenCode updates.
#
# Usage: ./extract-opencode-prompts.sh
# Output: ~/.maestro/cache/opencode-prompts/
# =============================================================================
...
CACHE_DIR="$HOME/.maestro/cache/opencode-prompts"
OPENCODE_BIN=""
