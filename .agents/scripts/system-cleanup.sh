...
# for the Maestro Framework. Includes lock file protection and 90-day logging.
#
...
readonly LOCK_FILE="/tmp/maestro-${SCRIPT_NAME}.lock"
readonly TMP_DIR="$HOME/.agents/tmp"
readonly AGENT_DIR="$HOME/.agents"
readonly PROJECT_DIR="$HOME/git/maestro"
...
main() {
	...
	cleanup_directory "/tmp" "maestro-*.lock" 1 "Stale Lock Files (>24h)"
