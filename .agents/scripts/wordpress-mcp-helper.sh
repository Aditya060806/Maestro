...
CONFIG_FILE="${HOME}/.config/maestro/wordpress-sites-config.json"
TEMPLATE_FILE="${HOME}/.maestro/agents/configs/wordpress-sites-config.json.txt"
CREDENTIALS_FILE="${HOME}/.config/maestro/credentials.sh"
...
Configuration:
  Sites config: ~/.config/maestro/wordpress-sites-config.json
  Template:     ~/.maestro/agents/configs/wordpress-sites-config.json.txt
  MCP env:      ~/.config/maestro/credentials.sh

Setup:
  mkdir -p ~/.config/maestro
  cp ~/.maestro/agents/configs/wordpress-sites-config.json.txt ~/.config/maestro/wordpress-sites-config.json
