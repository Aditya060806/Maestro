...
# issues (prevents noise from every maestro user running a pulse against public
...
_check_write_permission() {
	...
	# #maestro:trust-boundary — quality-feedback issue creation requires
...
_resolve_scan_state_file() {
	...
	local state_dir="${HOME}/.maestro/logs"
	mkdir -p "$state_dir"
...
cmd_scan_merged() {
	...
	# issues. Prevents noise from every maestro user filing quality-debt on
