...
# =============================================================================
# maestro Reach Feedback Library
# =============================================================================
...
if output_format == "json":
    ...
    print("- `EDIT: .agents/maestro/feedback.md` — document any threshold or review-gate change.")
    print("")
    print("## Verification")
    print("```bash")
    print("shellcheck .agents/scripts/reach-helper.sh")
    print(".agents/scripts/tests/test-reach-feedback.sh")
    print("./maestro.sh reach feedback mine --window 7d --format json")
    print("```")
    print("")
