...
write_command "full-loop" \
	...
	'Read ~/.maestro/agents/scripts/commands/full-loop.md and follow its instructions.
...
write_command "remember" \
	...
	'Read ~/.maestro/agents/scripts/commands/remember.md and follow its instructions.
...
write_command "recall" \
	...
	'Read ~/.maestro/agents/scripts/commands/recall.md and follow its instructions.
