...
SANDBOX_ROOT="${MAESTRO_OUTPUT_SANDBOX_DIR:-${HOME}/.maestro/.agent-workspace/output-sandbox}"
SANDBOX_DB="${MAESTRO_OUTPUT_SANDBOX_DB:-${SANDBOX_ROOT}/output-sandbox.db}"
RAW_DIR="${MAESTRO_OUTPUT_SANDBOX_RAW_DIR:-${SANDBOX_ROOT}/raw}"
DEFAULT_SUMMARY_LINES="${MAESTRO_OUTPUT_SANDBOX_SUMMARY_LINES:-20}"
DEFAULT_RETENTION_DAYS="${MAESTRO_OUTPUT_SANDBOX_RETENTION_DAYS:-14}"
