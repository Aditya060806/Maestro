...
readonly SUPERVISOR_DIR="${SUPERVISOR_DIR:-${HOME}/.maestro/.agent-workspace/supervisor}"
readonly REMOTE_LOG_DIR="${REMOTE_DISPATCH_LOG_DIR:-${SUPERVISOR_DIR}/logs/remote}"
readonly REMOTE_WORK_BASE="/tmp/maestro-worker"
...
_build_credential_env() {
	...
	env_vars+=("MAESTRO_REMOTE_DISPATCH=true")
