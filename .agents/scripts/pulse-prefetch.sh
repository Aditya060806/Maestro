...
#
# Scans todo/missions/ and ~/.maestro/missions/ for mission.md files
...
prefetch_missions() {
	...
	local homeless_dir="${HOME}/.maestro/missions"
...
prefetch_foss_scan() {
	...
	local config_jsonc="${HOME}/.config/maestro/config.jsonc"
