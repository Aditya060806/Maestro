...
#   MAESTRO_OLLAMA_BUNDLE       Path to bundle config (default: ~/.maestro/configs/ollama-bundle.json)
#
# Examples:
...
_warn_bundle_disk_estimate() {
	local model="$1"
	local bundle_path="${MAESTRO_OLLAMA_BUNDLE:-$HOME/.maestro/configs/ollama-bundle.json}"
...
Environment:
  ...
  MAESTRO_OLLAMA_BUNDLE   Path to bundle config JSON
