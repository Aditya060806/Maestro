...
#     SHELLCHECK_BACKOFF_DIR  — Directory for rate-limit state (default: ~/.maestro/.agent-workspace/tmp)
#
# GH#2915: https://github.com/Aditya060806/Maestro/issues/2915
...
readonly BACKOFF_DIR="${SHELLCHECK_BACKOFF_DIR:-${HOME}/.maestro/.agent-workspace/tmp}"
