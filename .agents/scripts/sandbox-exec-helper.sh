...
readonly SANDBOX_DIR="${HOME}/.maestro/.agent-workspace/sandbox"
...
sandbox_run() {
	...
	local secret_io_guard="${MAESTRO_BLOCK_SECRET_IO:-$SECRET_IO_GUARD_DEFAULT}"
...
sandbox_config() {
	...
	echo "  Secret guard: ${MAESTRO_BLOCK_SECRET_IO:-$SECRET_IO_GUARD_DEFAULT}"
...
Examples:
  ...
  sandbox-exec-helper.sh run --allow-secret-io gopass show maestro/EXAMPLE
