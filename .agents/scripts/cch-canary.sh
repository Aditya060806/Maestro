...
CANARY_LOG="${HOME}/.maestro/logs/cch-canary.log"
CANARY_STATE="${HOME}/.maestro/cch-canary-state.json"
SCRIPTS_DIR="${HOME}/.maestro/agents/scripts"
PLIST_LABEL="sh.maestro.cch-canary"
...
<dict>
    ...
    <string>${HOME}/.maestro/logs/cch-canary-stdout.log</string>
    <key>StandardErrorPath</key>
    <string>${HOME}/.maestro/logs/cch-canary-stderr.log</string>
