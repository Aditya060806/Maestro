...
export interface ExecApprovalConfig {
  /** Commands that execute immediately without approval (e.g., "maestro status") */
  allowlist: string[];
...
export interface BotConfig {
  ...
  /** Data directory for bot state (default: ~/.maestro/.agent-workspace/simplex-bot) */
  dataDir?: string;
}
...
export const DEFAULT_BOT_CONFIG: BotConfig = {
  ...
  welcomeMessage: "Hello! I'm an maestro bot. Type /help for available commands.",
  logLevel: "info",
