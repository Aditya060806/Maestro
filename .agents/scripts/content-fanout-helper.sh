...
readonly WORKSPACE_DIR="${HOME}/.maestro/.agent-workspace/work/content-fanout"
...
cmd_help() {
	...
	echo "  content-fanout-helper.sh run ~/.maestro/.agent-workspace/work/content-fanout/plans/my-topic.plan"
	echo ""
	echo "  # Check progress"
	echo "  content-fanout-helper.sh status ~/.maestro/.agent-workspace/work/content-fanout/plans/my-topic.plan"
	echo ""
