...
# Paths
readonly VAULT_BASE_DIR="$HOME/.maestro/.agent-workspace/vaults"
readonly VAULT_MOUNT_DIR="$HOME/.maestro/.agent-workspace/mounts"
readonly VAULT_REGISTRY="$HOME/.maestro/.agent-workspace/vault-registry.json"
...
cmd_help() {
    echo ""
    print_info "Maestro - gocryptfs Encrypted Filesystem"
    echo ""
    ...
    echo ""
    echo "  # Files in ~/.maestro/.agent-workspace/mounts/project-secrets/"
    ...
    echo ""
    print_info "Integration with maestro:"
    echo ""
