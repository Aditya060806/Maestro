...
"""
email_poll.py - IMAP polling script for the maestro knowledge plane.
...
Part of maestro email-poll system (t2855).
...
Config:      ~/.config/maestro/mailboxes.json or _config/mailboxes.json
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="IMAP polling for maestro knowledge plane (t2855)"
    )
