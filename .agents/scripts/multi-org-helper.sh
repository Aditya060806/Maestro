...
# Manages multi-org data isolation for maestro framework
#
...
readonly PROJECT_ORG_FILE=".maestro-org"
...
cmd_context() {
	...
	echo "export MAESTRO_ORG_SLUG=\"$active_org\""
	echo "export MAESTRO_ORG_NAME=\"$name\""
	echo "export MAESTRO_ORG_PLAN=\"$plan\""
