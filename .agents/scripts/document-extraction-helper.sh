...
# Document Extraction Helper for Maestro Framework
...
readonly WORKSPACE_DIR="${HOME}/.maestro/.agent-workspace/work/document-extraction"
...
# Show help
do_help() {
	echo "Document Extraction Helper - Maestro Framework"
	echo ""
