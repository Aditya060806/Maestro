...
LOGFILE="${LOGFILE:-${HOME}/.maestro/logs/stats.log}"
QUALITY_SWEEP_INTERVAL="${QUALITY_SWEEP_INTERVAL:-86400}"
PERSON_STATS_INTERVAL="${PERSON_STATS_INTERVAL:-3600}"
QUALITY_SWEEP_LAST_RUN="${QUALITY_SWEEP_LAST_RUN:-${HOME}/.maestro/logs/quality-sweep-last-run}"
PERSON_STATS_LAST_RUN="${PERSON_STATS_LAST_RUN:-${HOME}/.maestro/logs/person-stats-last-run}"
PERSON_STATS_CACHE_DIR="${PERSON_STATS_CACHE_DIR:-${HOME}/.maestro/logs}"
QUALITY_SWEEP_STATE_DIR="${QUALITY_SWEEP_STATE_DIR:-${HOME}/.maestro/logs/quality-sweep-state}"
