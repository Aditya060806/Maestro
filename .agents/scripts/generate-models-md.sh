...
readonly SCORING_DB="${SCORING_DB_OVERRIDE:-$HOME/.maestro/.agent-workspace/response-scoring.db}"
readonly REGISTRY_DB="${MODEL_REGISTRY_DB:-$HOME/.maestro/.agent-workspace/model-registry.db}"
...
generate_global_md() {
...

	{
		...
		echo "---"
		echo ""
		echo "*Generated by [maestro](https://github.com/Aditya060806/Maestro) t1012, t1133*"
	} >"$output"
