...
| Argument | Command |
|----------|---------|
| HTML file path | `~/.maestro/agents/scripts/email-test-suite-helper.sh test-design "$ARGUMENTS"` |
| Domain | `~/.maestro/agents/scripts/email-test-suite-helper.sh check-placement "$ARGUMENTS"` |
| `smtp <host> <port>` | `~/.maestro/agents/scripts/email-test-suite-helper.sh smtp "$ARGUMENTS"` |
| `headers <file>` | `~/.maestro/agents/scripts/email-test-suite-helper.sh headers "$ARGUMENTS"` |
| `accessibility <file>` | `~/.maestro/agents/scripts/email-test-suite-helper.sh test-design "$ARGUMENTS"` |
| `generate` | `~/.maestro/agents/scripts/email-test-suite-helper.sh generate` |
