...
**Only permitted senders can trigger maestro tasks via email.** Config: `~/.config/maestro/email-permitted-senders.conf` — format: `email_address|permission_level|description`. Levels: `admin > operator > reporter > readonly`.
