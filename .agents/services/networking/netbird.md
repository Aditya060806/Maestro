...
Package: https://github.com/Aditya060806/cloudron-netbird-app. Add-ons: `postgresql`, `localstorage`, `oidc`, `turn`.
...
curl -s -X POST "https://netbird.example.com/api/setup-keys" \
  ...
  -d '{"name":"maestro-workers","type":"reusable","expires_in":604800,"auto_groups":["ai-workers"],"usage_limit":50}'
...
- https://github.com/Aditya060806/cloudron-netbird-app (Cloudron package)
