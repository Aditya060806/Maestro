...
- **Config**: `~/.config/maestro/google-chat-bot.json` (600 perms)
...
```bash
gcloud projects create maestro-chat-bot --name="maestro Chat Bot"
gcloud config set project maestro-chat-bot
gcloud services enable chat.googleapis.com
gcloud iam service-accounts create chat-bot --display-name="Chat Bot Service Account"
gcloud iam service-accounts keys create ~/.config/maestro/google-chat-sa-key.json \
  --iam-account=chat-bot@maestro-chat-bot.iam.gserviceaccount.com
chmod 600 ~/.config/maestro/google-chat-sa-key.json
```
...
`~/.config/maestro/google-chat-bot.json` (600 perms):
