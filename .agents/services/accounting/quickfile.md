...
- **MCP Server**: [quickfile-mcp](https://github.com/Aditya060806/quickfile-mcp) (TypeScript, stdio)
...
- **Related**: `@accounts` (parent), `@maestro` (infrastructure)
...
quickfile-helper.sh batch-record ~/.maestro/.agent-workspace/work/ocr-receipts/
```
...
# Option B: manual
mkdir -p ~/Git/mcp
git clone https://github.com/Aditya060806/quickfile-mcp.git ~/Git/mcp/quickfile-mcp
...
**Resources**: [MCP Repo](https://github.com/Aditya060806/quickfile-mcp) | [Support](https://support.quickfile.co.uk/) | [Community](https://community.quickfile.co.uk/) | [API Docs](https://api.quickfile.co.uk/) | [Context7](https://context7.com/websites/api_quickfile_co_uk)
