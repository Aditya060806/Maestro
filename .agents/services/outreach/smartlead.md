...
- **Auth**: API key as query parameter (`?api_key=...`). Get from Smartlead dashboard > Settings > API Keys. Store: `maestro secret set smartlead-api-key` or `export SMARTLEAD_API_KEY="your-key-here"` (run in terminal, not AI chat)
