...
### vs existing maestro observability
...
Source from maestro credential store: `source ~/.config/maestro/credentials.sh`
...
Can be added to a launchd plist (`sh.maestro.langwatch-update`) or run manually.
