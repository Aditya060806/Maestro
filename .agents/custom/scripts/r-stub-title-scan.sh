...
#   STUB_SCAN_INCIDENT_REPO  Where to file incident issues (default: Aditya060806/Maestro)
#   STUB_SCAN_DRY_RUN=1      Equivalent to --dry-run flag
#
# State:
#   ~/.maestro/logs/stub-title-incidents.log  — detection log (rotated at 1MB, 5 kept)
#   ~/.maestro/cache/stub-title-seen.json     — 24h dedup cache
#
...
FRAMEWORK_SCRIPTS="${HOME}/.maestro/agents/scripts"
...
LOGFILE="${HOME}/.maestro/logs/stub-title-incidents.log"
SEEN_CACHE="${HOME}/.maestro/cache/stub-title-seen.json"
INCIDENT_REPO="${STUB_SCAN_INCIDENT_REPO:-Aditya060806/Maestro}"
...
<!-- maestro:generator=r-stub-title-scan -->
BODY
    return 0
}
