...
- [x] v003 t008 maestro-opencode Plugin #plan → [todo/PLANS.md#aidevop... | PR #1073 | merged:2026-02-11 | verified:2026-02-11 (subagent-index gap fixed in PR #1133)
  files: .agents/plugins/opencode-maestro/index.mjs, .agents/plugins/opencode-maestro/package.json, .agents/tools/build-mcp/maestro-plugin.md
  check: file-exists .agents/plugins/opencode-maestro/index.mjs
  check: file-exists .agents/plugins/opencode-maestro/package.json
  check: file-exists .agents/tools/build-mcp/maestro-plugin.md
  check: rg "maestro-plugin" .agents/subagent-index.toon
...
- [!] v011 t008.1 Core plugin structure + agent loader ~4h #auto-dispatch | PR #1138 | merged:2026-02-11 failed:2026-02-12 reason:shellcheck: .agents/scripts/plugin-loader-helper.sh has violations
  files: .agents/maestro/plugins.md, .agents/scripts/plugin-loader-helper.sh, .agents/subagent-index.toon, .agents/templates/plugin-template/plugin.json, .agents/templates/plugin-template/scripts/on-init.sh, .agents/templates/plugin-template/scripts/on-load.sh, .agents/templates/plugin-template/scripts/on-unload.sh, maestro.sh
  check: file-exists .agents/maestro/plugins.md
  ...
  check: shellcheck maestro.sh
  check: file-exists maestro.sh

- [x] v012 t008.3 Quality hooks (pre-commit) ~3h #auto-dispatch blocked-by:... | PR #1150 | merged:2026-02-11 verified:2026-02-12
  files: .agents/plugins/opencode-maestro/index.mjs, .agents/tools/build-mcp/maestro-plugin.md
  check: file-exists .agents/plugins/opencode-maestro/index.mjs
  check: file-exists .agents/tools/build-mcp/maestro-plugin.md
  check: rg "maestro-plugin" .agents/subagent-index.toon

- [x] v013 t293 Graduate high-confidence memories into docs — run `memo... | PR #1152 | merged:2026-02-11 verified:2026-02-12
  files: .agents/maestro/graduated-learnings.md
  check: file-exists .agents/maestro/graduated-learnings.md
...
- [x] v019 t284 Fix opencode plugin createTools() Zod v4 crash — hotfix | PR #1103 | merged:2026-02-11 verified:2026-02-12
  files: .agents/plugins/opencode-maestro/index.mjs
  check: file-exists .agents/plugins/opencode-maestro/index.mjs
...
- [x] v024 Homebrew install offer + Beads binary download fallback for Linux | PR #1168 | merged:2026-02-11 | verified:2026-02-11
  files: setup.sh, .agents/scripts/beads-sync-helper.sh, maestro.sh
  check: shellcheck setup.sh
  check: file-exists setup.sh
...
- [x] v027 t307 Fix missing validate_namespace call in maestro.sh — re... | PR #1189 | merged:2026-02-12 verified:2026-02-12
  files: maestro.sh
  check: shellcheck maestro.sh
  check: file-exists maestro.sh
...
- [x] v032 t308 Fix help text in maestro.sh — help text omits the `[na... | PR #1191 | merged:2026-02-12 verified:2026-02-12
  files: maestro.sh
  check: shellcheck maestro.sh
  check: file-exists maestro.sh
...
- [x] v036 t311.1 Audit and map supervisor-helper.sh functions by domain �... | PR #1207 | merged:2026-02-12 verified:2026-02-12
  files: .agents/maestro/supervisor-module-map.md
  check: file-exists .agents/maestro/supervisor-module-map.md
...
- [x] v059 t1027 Refactor opencode-maestro/index.mjs — 14 qlty smells, ... | PR #1349 | merged:2026-02-13 verified:2026-02-13
  files: .agents/plugins/opencode-maestro/index.mjs, .agents/plugins/opencode-maestro/tools.mjs
  check: file-exists .agents/plugins/opencode-maestro/index.mjs
  check: file-exists .agents/plugins/opencode-maestro/tools.mjs
...
- [x] v181 t1200.5 CLI interface and agent framework integration for IP repu... | PR #1883 | merged:2026-02-19 verified:2026-02-19
  files: .agents/AGENTS.md, maestro.sh
  check: file-exists .agents/AGENTS.md
  check: shellcheck maestro.sh
  check: file-exists maestro.sh
...
- [!] v206 t1224.8 Integrate localdev with maestro worktree workflow — wh... | PR #1948 | merged:2026-02-19 failed:2026-02-19 reason:rg: "worktree" not found in .agents/subagent-index.toon
...
- [!] v220 t1264 Daily repo sync: auto-pull latest for git repos in config... | PR #1989 | merged:2026-02-20 failed:2026-02-20 reason:shellcheck: setup.sh has violations
  files: .agents/maestro/onboarding.md, .agents/scripts/repo-sync-helper.sh, maestro.sh, setup.sh
  check: file-exists .agents/maestro/onboarding.md
...
- [x] v222 t1264.1 Add `git_parent_dirs` config to repos.json — extend `in... | PR #1997 | merged:2026-02-20 verified:2026-02-20
  files: .agents/scripts/repo-sync-helper.sh, maestro.sh
  check: shellcheck .agents/scripts/repo-sync-helper.sh
  check: file-exists .agents/scripts/repo-sync-helper.sh
  check: shellcheck maestro.sh
  check: file-exists maestro.sh
...
- [x] v228 t1264.3 Integrate into maestro CLI and setup.sh — add `repo-sy... | PR #2016 | merged:2026-02-20 verified:2026-02-20
...
- [x] v238 t1278 Feature: Interactive Skill Discovery & Management CLI (ai... | PR #2030 | merged:2026-02-20 verified:2026-02-20
  files: .agents/AGENTS.md, .agents/scripts/commands/skills.md, .agents/scripts/skills-helper.sh, .agents/subagent-index.toon, maestro.sh
  check: file-exists .agents/AGENTS.md
...
- [x] v239 t1280 Extend skills discovery with external skills.sh registry ... | PR #2035 | merged:2026-02-20 verified:2026-02-20
  files: .agents/AGENTS.md, .agents/scripts/commands/skills.md, .agents/scripts/skills-helper.sh, maestro.sh
  check: file-exists .agents/AGENTS.md
  check: file-exists .agents/scripts/commands/skills.md
  check: shellcheck .agents/scripts/skills-helper.sh
  check: file-exists .agents/scripts/skills-helper.sh
...
- [ ] v251 t1290 Add Cloudflare Code Mode MCP server config and subagent d... | PR #2077 | merged:2026-02-21
  files: .agents/maestro/mcp-integrations.md, .agents/subagent-index.toon, .agents/tools/api/cloudflare-mcp.md, configs/mcp-servers-config.json.txt
  check: file-exists .agents/maestro/mcp-integrations.md
  check: file-exists .agents/subagent-index.toon
...
- [ ] v258 t1294.3 Update `mcp-integrations.md` and `mcp-discovery.md` — a... | PR #2084 | merged:2026-02-21
  files: .agents/maestro/mcp-integrations.md, .agents/tools/context/mcp-discovery.md
  check: file-exists .agents/maestro/mcp-integrations.md
...
- [x] v266 t1288.5 Update `mcp-integrations.md` and `subagent-index.toon` �... | PR #2092 | merged:2026-02-21 verified:2026-02-21
  files: .agents/maestro/mcp-integrations.md, .agents/subagent-index.toon
  check: file-exists .agents/maestro/mcp-integrations.md
  check: file-exists .agents/subagent-index.toon
...
- [x] v282 t1307 LLM observability: SQLite-based request tracking — crea... | PR #2137 | merged:2026-02-22 verified:2026-02-22
  files: .agents/scripts/observability-helper.sh, maestro.sh
...
- [x] v284 t1308 LLM observability: data collection from OpenCode plugin �... | PR #2138 | merged:2026-02-22 verified:2026-02-22
  files: .agents/plugins/opencode-maestro/index.mjs, .agents/plugins/opencode-maestro/observability.mjs
  check: file-exists .agents/plugins/opencode-maestro/index.mjs
  check: file-exists .agents/plugins/opencode-maestro/observability.mjs
...
- [x] v308 t1338.2 Create local-models.md subagent #auto-dispatch — new `.ag... | PR #2391 | merged:2026-02-26 verified:2026-02-26
  files: .agents/scripts/maestro-update-check.sh, .agents/subagent-index.toon, .agents/tools/local-models/local-models.md
  check: shellcheck .agents/scripts/maestro-update-check.sh
  check: file-exists .agents/scripts/maestro-update-check.sh
  check: file-exists .agents/subagent-index.toon
  check: file-exists .agents/tools/local-models/local-models.md
  check: rg "local-models" .agents/subagent-index.toon
