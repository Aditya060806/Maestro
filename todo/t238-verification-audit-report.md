...
| t200 | NO_PR | 6 commits | Evaluate and import Veo 3 Meta Framework as maestro skill |
...
| t166 | PR#657 | 3 files | Daily CodeRabbit full codebase review pulse for self-improving maestro |
...
| t169 | PR#646 | 1 files | Fix `maestro update` skipping agent deployment — pass `--non-interactive` to setup.sh |
...
| t138 | PR#426 | 2 files | maestro update output overwhelms tool buffer on large updates |
...
| t136.1 | PR#755 | 2 files | Add plugin support to .maestro.json schema |
...
| t136.5 | PR#792 | 2 files | Scaffold maestro-pro and maestro-anon repos |
...
| t082 | PR#362 | 1 files | Fix version sync inconsistency (VERSION vs package.json/setup.sh/maestro.sh) |
...
| t068.2 | NO_PR | 3 commits | Compaction Plugin (opencode-maestro-plugin) |
...
| t016 | PR#594 | 6 files | Uncloud Integration for maestro |
| t017 | PR#599 | 15 files | SEO Machine Integration for maestro |
...
| t046 | NO_PR | 3 commits | Review OpenClaw (formerly Moltbot, Clawdbot) for inspiration and incorporation into maestro |
...
| t060 | PR#563 | 1 files | Research jj (Jujutsu) VCS for maestro advantages |
| t061 | PR#486 | 8 files | Create debug-opengraph and debug-favicon subagents |
| t062 | PR#559 | 1 files | Research vercel-labs/agent-skills for inclusion in maestro |
...
| t103 | PR#347 | 2 files | Review Pi agent for maestro inspiration |
...
| t120 | PR#665 | 3 files | Review @thymikee post for maestro inclusion |
...
| t079 | PR#226 | 8 files | Consolidate Plan+ and Maestro into Build+ |
| t079.8 | NO_PR | 4 commits | Update setup.sh and maestro update to cleanup removed agents |
...
| t134.3 | PR#751 | 4 files | Update maestro init with optional SOPS setup |
...
| t010 | NO_PR | 3 commits | Evaluate Merging build-agent and build-mcp into maestro |
...
| t019 | PLAN_TASK | subtasks completed | Beads Integration for maestro |
...
| t131.2 | NO_EVIDENCE | Part B: gopass integration + maestro secret wrapper |
...
| t130.3 | NO_EVIDENCE | Verify maestro init creates .agents symlink (not .agent) in a test project |
...
| t079.1 | NO_EVIDENCE | Audit Maestro for unique knowledge to merge into Build+ |
...
| t079.5 | NO_EVIDENCE | Remove Maestro from primary agents |
