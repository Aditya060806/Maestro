...
Enumerate every code path, test, doc, workflow, and config that references `auto-dispatch` in the maestro framework, classified by semantic role and assigned to the phase that will modify it. This closes the scope gate for t2721.
...
| `.agents/workflows/log-issue-maestro.md` | 37, 62 | When auto-dispatch should/shouldn't be applied |
...
| `.agents/maestro/onboarding.md` | 133 | Onboarding tutorial mentions tag |
| `.agents/maestro/orchestration-analysis.md` | 83 | Analysis doc |
