...
**Issue:** GH#19716 (Aditya060806/Maestro). **Blocked-by:** GH#19712 (t2209) — the hook cannot be edited without `--no-verify` until the t2209 fix lands.
...
See issue body at https://github.com/Aditya060806/Maestro/issues/19716 for:
