...
prd-memory-auto-capture,Memory Auto-Capture,maestro,completed,1d,6h,4h,2h,2026-01-11T12:00Z
-->
...
Currently, maestro memory requires manual `/remember` invocation. Users must consciously decide what to store, leading to:
- Forgotten solutions that worked
- Repeated debugging of the same issues
- Lost context between sessions
- Inconsistent memory capture across users

claude-mem solves this with automatic capture via lifecycle hooks, but is Claude Code-only. maestro needs a tool-agnostic solution.
...
| Feature | claude-mem | maestro (proposed) |
|---------|------------|---------------------|
...
| Date | Author | Changes |
|------|--------|---------|
| 2026-01-11 | maestro | Initial draft |
