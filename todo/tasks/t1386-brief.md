...
- State tracking: `~/.maestro/logs/review-scan-state-{slug}.json` stores scanned PR numbers to avoid re-processing
...
- GitHub issue: #2785
- Worktree: `~/Git/maestro-feature-t1386-review-scanner`
