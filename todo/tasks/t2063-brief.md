...
source ~/.maestro/agents/scripts/issue-sync-lib.sh
REPO_PATH=/tmp/test-t2063 bash -c 'source ~/.maestro/agents/scripts/claim-task-id.sh; _compose_issue_body "t9999: test" ""' | grep -c "## Task Brief"
# Expected: 1
