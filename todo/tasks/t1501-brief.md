...
Create `scripts/email-voice-miner.py` — analyze sent mail folder to extract and condense user writing patterns into a style guide stored at `~/.maestro/.agent-workspace/email-intelligence/voice-profile-{account}.md`. Extracts:
...
- Store at `~/.maestro/.agent-workspace/email-intelligence/` with 600 permissions
