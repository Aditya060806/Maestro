...
1. **Scanner emits a generator marker**
   ...
   - Add an HTML comment marker to the body:
     ...
     ```html
     <!-- maestro:generator=large-file-simplification-gate cited_file=<path> threshold=2000 -->
     ```
...
- [ ] All scanner-filed large-file / complexity issues carry a `<!-- maestro:generator=... -->` marker
