...
1. **Allowlist**: Safe commands (e.g., `maestro status`) execute immediately without approval
...
- Allowlist uses prefix matching (e.g., "maestro status" matches "maestro status --verbose")
