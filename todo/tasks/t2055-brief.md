...
- [ ] Post-Phase-2: manual smoke test — `sudo maestro approve issue <N>` on a contributor-filed issue carrying `status:in-review` clears the label idempotently
