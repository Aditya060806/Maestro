...
All four are env-overridable / config-overridable. Users wanting prior behaviour can revert via env vars or `maestro settings set`.
...
<!-- maestro:sig -->
---
[maestro.sh](https://maestro.sh) v3.8.94 plugin for [OpenCode](https://opencode.ai) v1.14.20 with claude-opus-4-7 spent 46m and 33,397 tokens on this with the user in an interactive session.
