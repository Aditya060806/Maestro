...
Categories to include (adapted from mngr, filtered for maestro context):
...
- Examples should use maestro-specific scenarios (shell scripts, helper scripts, agent docs), not generic Python examples
