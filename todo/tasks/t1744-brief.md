...
- **Simplification as a positive outcome**: removing code and getting equal or better results is explicitly encouraged. This aligns with maestro's efficiency-drive aims.
...
- `~/.maestro/.agent-workspace/mail/mailbox.db` — SQLite mailbox database
