...
~/.maestro/agents/scripts/worktree-helper.sh add feature/t9999b-test  # should warn
~/.maestro/agents/scripts/worktree-helper.sh add feature/t9999-test   # should pass cleanly
~/.maestro/agents/scripts/worktree-helper.sh add chore/t2228-lifecycle-retrospective  # pass
```
