...
Create the device identity and trust model for multi-machine maestro Vault fleets, including per-device keys, local unlock state, heartbeat metadata, capabilities, revocation, and policy for cloud VPS vs local machines.
