...
6. `maestro knowledge add` (from t2843) auto-detects `.eml` extension and routes through this helper
...
- EDIT: `.agents/maestro/knowledge-plane.md` (email kind section)

## Acceptance Criteria

- [ ] `maestro knowledge add /path/to/email.eml` creates a parent source with `kind=email` and full email-specific meta
...
- [ ] Documentation: email kind section in `.agents/maestro/knowledge-plane.md`
