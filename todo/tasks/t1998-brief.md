...
1. **Isolated trace** — manually run the re-eval loop after the fix and confirm #18346 clears:
    ...
    body=$(gh issue view 18346 --repo Aditya060806/Maestro --json body --jq .body)
    _issue_targets_large_files 18346 Aditya060806/Maestro "$body" /Users/Aditya060806/Git/maestro "true"
...
2. **Non-regression test** — confirm #18348 and #18418 remain gated (their files really are still large):
    ...
    for n in 18348 18418; do
        body=$(gh issue view $n --repo Aditya060806/Maestro --json body --jq .body)
        if _issue_targets_large_files $n Aditya060806/Maestro "$body" /Users/Aditya060806/Git/maestro "true"; then
