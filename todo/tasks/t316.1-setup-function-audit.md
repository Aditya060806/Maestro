...
| `validate_namespace` | 288 | deploy_maestro_agents | bash regex |
...
| `add_local_bin_to_path` | 2754 | install_maestro_cli | mkdir, touch, grep |
| `install_maestro_cli` | 2803 | main | bash, chmod, ln |
...
| `deploy_maestro_agents` | 3076 | main | cd, pwd, jq, rsync, tar, mkdir, find, wc, cp, grep, awk, mv |
| `sanitize_plugin_namespace` | 3274 | 2 functions | basename |
| `deploy_plugins` | 3293 | deploy_maestro_agents | jq, git, rm, chmod |
