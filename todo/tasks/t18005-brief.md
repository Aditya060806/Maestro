...
Add secure device-to-device messaging for maestro machines, with encrypted messages readable only when the receiving Vault is unlocked, using Git as an untrusted durable mailbox and SimpleX as an optional lower-metadata transport.
