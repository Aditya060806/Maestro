...
`.agents/plugins/opencode-maestro/observability.mjs:503-546`:
...
Evidence (verified against live DB `~/.maestro/.agent-workspace/observability/llm-requests.db`,
...
- NEW: `.agents/plugins/opencode-maestro/timing-tracing.mjs`
- NEW: `.agents/plugins/opencode-maestro/tests/test-timing-tracing.mjs`
- NEW: `.agents/plugins/opencode-maestro/tests/test-observability-tool-calls.mjs`
- EDIT: `.agents/plugins/opencode-maestro/quality-hooks.mjs` (3 lines)
- EDIT: `.agents/plugins/opencode-maestro/observability.mjs` (extract builder + expand INSERT)

## Acceptance

1. All new test assertions pass under `node --test .agents/plugins/opencode-maestro/tests/`.
...
```bash
sqlite3 -header -column ~/.maestro/.agent-workspace/observability/llm-requests.db \
