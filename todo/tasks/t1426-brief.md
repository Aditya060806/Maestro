...
- Per-repo cache: `~/.maestro/logs/person-stats-cache-{slug-safe}.md`
- Cross-repo cache: `~/.maestro/logs/person-stats-cache-cross-repo.md`
- Timestamp file: `~/.maestro/logs/person-stats-last-run`
