...
- Add or update top-level discovery references where browser tool selection is surfaced, including `.agents/build-plus.md:126`, `.agents/reference/domain-index.md:14`, and `.agents/maestro/mcp-integrations.md:258` if needed.
...
- `.agents/maestro/mcp-integrations.md:258` — new guide link already added via PR #14956.
