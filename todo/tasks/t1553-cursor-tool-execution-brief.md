...
- `.agents/plugins/opencode-maestro/index.mjs` — register tool handlers
- `.agents/plugins/opencode-maestro/cursor-proxy.mjs` — re-enable `tool_call: true`
- `.agents/plugins/opencode-maestro/cursor/proxy.js` — may need adjustments for tool result handling

### Files to create

- `.agents/plugins/opencode-maestro/cursor-tools.mjs` — tool handler implementations
