...
The canonical brief for this task lives in the linked GitHub issue body: **https://github.com/Aditya060806/Maestro/issues/20205**.
...
User-observed incident. `~/Git/maestro/` was moved to `~/.Trash/` at 2026-04-20 23:50:01 by an automated worktree cleanup pass. Survived briefly via inode-held pulse writes; auto-recovered by a fresh `git clone` at 2026-04-21 00:02:20. Root-caused and patched in interactive session 2026-04-21.
