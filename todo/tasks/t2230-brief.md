...
# Cleanup:
gh release delete v0.0.0-test-release --repo Aditya060806/Maestro --yes
git push origin --delete v0.0.0-test-release
git tag -d v0.0.0-test-release

# Real validation: next patch release
~/.maestro/agents/scripts/version-manager.sh release patch
# After ~30s:
gh release view v$(cat VERSION) --repo Aditya060806/Maestro
```
