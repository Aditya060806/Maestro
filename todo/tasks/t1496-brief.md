...
Also create a **common attachments library** concept: `~/.maestro/.agent-workspace/email-attachments/` for frequently-sent files (company info, rate cards, brochures) with a manifest tracking what's available.
