...
- New `.agents/scripts/stats-wrapper.sh` — extract stats logic into standalone script with PID dedup, hard timeout (10 min), and its own log file (`~/.maestro/logs/stats.log`)
