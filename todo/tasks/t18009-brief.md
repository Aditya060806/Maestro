...
Create the Vault agent/guidance layer so maestro sessions understand Vault capabilities, ask the right setup/management questions, refuse unsafe requests, and annotate tasks with vault/sync/provider requirements.
...
- NEW: `.agents/scripts/commands/vault.md` and command docs for `maestro vault` / `maestro fleet` flows.
