...
4. **Manual smoke test** on the live repo:
   ...
   ```bash
   # Source stats-functions.sh in a shell, call _quality_sweep_for_repo on Aditya060806/Maestro
...
- Live repro: issue #2632 on `Aditya060806/Maestro`, most recent milohiss-authored comment
