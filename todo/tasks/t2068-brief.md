...
- **Parent task:** none
- **Conversation context:** The top smell contributors (`higgsfield/*.mjs`, `.agents/plugins/opencode-maestro/*.mjs`, `.opencode/lib/toon.ts`) all entered the repo already complex. Nothing in the ratchet ever required a *new* file to be smell-free before landing. Subsystems arrive as 300-line mega-modules and nobody refactors because "it worked when it landed".
