...
Currently there's no way to programmatically assess LLM output quality in maestro. Code review bots (CodeRabbit, Gemini) check code, but nothing checks LLM-generated content for hallucination, relevance, or safety. This matters for:
