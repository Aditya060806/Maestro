...
- **Created by:** Aditya Pandey and Harvest (ai-interactive)
- **Parent task:** n/a
...
- `jq '.initialized_repos[] | select(.pulse==true)' ~/.config/maestro/repos.json` (runner count)
- `~/.maestro/cache/pulse-instance-lock` contents if present
...
See issue body at https://github.com/Aditya060806/Maestro/issues/19347 — contains the 5-branch hypothesis tree and investigation methodology.
...
- `~/.maestro/cache/pulse-instance-lock` — lock file state
