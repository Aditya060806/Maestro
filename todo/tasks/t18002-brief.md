...
Add a first-class Vault link in the maestro app sidebar above Agents, create Vault setup/management surfaces, and render padlock indicators/tooltips wherever encrypted data appears.
...
5. Tooltip copy: encrypted by maestro Vault; contents visible only when unlocked through app or authorised vault commands.
