# t18001: vault: migrate maestro memory, workspace, knowledge, and config data with scrub-safe rollback
...
Move sensitive maestro data planes behind Vault storage with verified encrypt/decrypt migration, best-effort disk/memory scrubbing, rollback/manifest safety, and clear filesystem snapshot limitations.
