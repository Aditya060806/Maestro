...
## Context
- **Origin**: Headless continuation for issue #15042 (https://github.com/Aditya060806/Maestro/issues/15042)
- **File**: `.agents/maestro/api-integrations.md`
- **Goal**: Tighten and restructure the agent doc according to `code-simplifier.md` and `build-agent.md` guidance.

## What
- Tighten prose in `.agents/maestro/api-integrations.md`.
...
- [x] PR created: https://github.com/Aditya060806/Maestro/pull/15580
