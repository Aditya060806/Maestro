...
- **Non-goals**: This agent does NOT cover maestro internal memory (stays on SQLite FTS5), does NOT replace osgrep for code search, does NOT include a helper script (zvec is a library, not a CLI tool).
