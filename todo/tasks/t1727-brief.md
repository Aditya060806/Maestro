...
## Session Origin
- **User Request**: `/full-loop Implement issue #15129 (https://github.com/Aditya060806/Maestro/issues/15129) -- Simplification: tighten agent doc Ahrefs SEO Integration. Reduce line count while preserving all essential information.`
- **Task ID**: `t1727`
...
- Auth is handled via `AHREFS_API_KEY` in `~/.config/maestro/credentials.sh`.
