...
6. Cost tracking: aggregated per-day per-provider in `~/.maestro/.agent-workspace/llm-costs.json`
...
- EDIT: `.agents/maestro/knowledge-plane.md` (LLM routing section)
...
- [ ] Documentation: routing decision tree in `.agents/maestro/knowledge-plane.md`
