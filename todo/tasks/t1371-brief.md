...
- [ ] TOON file parses correctly (valid TOON syntax, all sections have correct field counts)
  ...
  verify:
    method: bash
    run: "bun run ~/.maestro/agents/scripts/toon-helper.ts decode .agents/tools/design/ui-ux-catalogue.toon 2>&1 | grep -v error"
  ```
