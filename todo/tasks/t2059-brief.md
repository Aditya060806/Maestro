...
grep -q "Worker triage responsibility" ~/Git/maestro/.agents/prompts/build.txt && echo "build.txt: OK"

# Rule is referenced in AGENTS.md
grep -q "Worker Triage Responsibility" ~/Git/maestro/.agents/AGENTS.md && echo "AGENTS.md: OK"

# Both files still parse / render
markdownlint-cli2 ~/Git/maestro/.agents/AGENTS.md 2>&1 | grep -v "^$" || echo "markdown: clean"
```
