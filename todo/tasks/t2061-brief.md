...
8. **Run the full test suite.** ShellCheck. Run `dispatch-dedup-helper.sh is-assigned 18458 Aditya060806/Maestro` and confirm it still returns `PARENT_TASK_BLOCKED` (the existing happy path must still work).
...
~/.maestro/agents/scripts/dispatch-dedup-helper.sh is-assigned 18458 Aditya060806/Maestro
