...
Current paragraph (`~/.maestro/agents/AGENTS.md`, section "Known limitation — sync-on-pr-merge TODO auto-completion (t2029)") says "Implementation tracked in t2048 (GH#18643)." Now that PR #18677 has merged but the secret still isn't operational, update to:
