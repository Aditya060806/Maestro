...
5. Add a regression test. Create or extend a test harness that:
   - Runs `pre-edit-check.sh --loop-mode --file todo/tasks/test-brief.md` with `MAESTRO_HEADLESS=true` → expects `LOOP_DECISION=stay` (exit 0)
