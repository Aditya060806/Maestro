...
- **Why a shell script not Python?** All existing maestro helpers are shell scripts. Consistency matters more than convenience. The computation is simple arithmetic.
