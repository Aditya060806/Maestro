...
- **Created by:** ai-interactive (Aditya Pandey and Harvest driving)
...
- **Positive t2218:** PR body with `For #X`, #X has `origin:interactive + auto-dispatch + assignee=Aditya060806 + no status:in-review` → helper calls `gh issue edit ... --remove-assignee Aditya060806`.
...
.agents/scripts/interactive-session-helper.sh post-merge <some-clean-PR> Aditya060806/Maestro
```
