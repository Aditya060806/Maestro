...
Maestro workloads may run across many machines. Availability should come from pre-synced encrypted replicas, not bypassing locked devices or exposing plaintext to Git hosts.
