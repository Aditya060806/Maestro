...
- [ ] `setup.sh --non-interactive` deploys the new build.txt to `~/.maestro/agents/prompts/build.txt`.
...
- **Bug PR:** [#18748](https://github.com/Aditya060806/Maestro/pull/18748) shipped the bare `_merge_out=$(...)` form that exits silently under `set -e`
- **Hotfix PR:** [#18750](https://github.com/Aditya060806/Maestro/pull/18750) switched to the if-form
