...
5. `MAESTRO_BASH_REEXECED=1 /bin/bash .agents/scripts/memory-pressure-monitor.sh --status` — guard skipped, fails loudly at line 488 `${cmd_name,,}` as expected (opt-out behaves correctly) ✓
