...
```bash
gh issue view 18346 --repo Aditya060806/Maestro
```
...
- `~/Git/maestro-feature-auto-*` directories (the visible symptom — many of these on the canonical machine right now)
