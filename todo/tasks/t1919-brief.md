...
- **Issue**: [GH#17755](https://github.com/Aditya060806/Maestro/issues/17755)
...
- [ ] Verification: `env -i HOME="$HOME" PATH="$PATH" bash --norc --noprofile -c 'source ~/.maestro/agents/scripts/model-availability-helper.sh; api_key=$(resolve_api_key "ANTHROPIC_API_KEY"); echo "length: ${#api_key}"'` — should show non-zero length.
