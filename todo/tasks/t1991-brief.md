...
- EDIT: `.agents/plugins/opencode-maestro/claude-proxy.mjs:886-910` — extract reasoning level from request, pass to `buildClaudeArgs`
- EDIT: `.agents/plugins/opencode-maestro/claude-proxy.mjs:440-482` — add `--effort` to CLI args
...
- Proxy file: `.agents/plugins/opencode-maestro/claude-proxy.mjs` (1009 lines after v3.7.0)
