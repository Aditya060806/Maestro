...
**Issue:** GH#19689 (Aditya060806/Maestro) — issue body is the canonical spec.
...
See issue body at https://github.com/Aditya060806/Maestro/issues/19689 for:
...
```bash
cd ~/Git/maestro
for i in $(seq 5); do ~/.maestro/agents/scripts/claim-task-id.sh --no-issue --title "repro $i" & done; wait
