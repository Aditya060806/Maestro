...
- **Conversation context:** User requested task decomposition for issue #2558 — a research review comparing maestro against Perplexity Computer and Microsoft Amplifier. This task covers the two near-term improvements: parallel model verification (item 1) and bundle-based project presets (item 4).

## What

Two independent workstreams that improve maestro reliability and performance:
...
- `~/.config/maestro/repos.json` — extend schema with bundle field
...
- `~/.config/maestro/repos.json` — repo configuration
