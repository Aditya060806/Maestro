...
| `hardcoded_maestro_path` | Literal `~/.maestro` or `/Users/` instead of `${HOME}/.maestro` or variable | `rg '~/.maestro\|/Users/' --type sh .agents/scripts/ -c` minus shebangs/comments |
...
```json
{
  ...
  "ratchets": {
    ...
    "hardcoded_maestro_path": { "count": 23, "description": "Literal ~/.maestro instead of variable" },
