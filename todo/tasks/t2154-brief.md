...
- `EDIT: .agents/plugins/opencode-maestro/config-hook.mjs:45-49` — change `200000` to `250000` in the `CLAUDE_MODEL_LIMITS` entry for `claude-opus-4-7`, update the comment to explain the auto-compact alignment.
- `EDIT: .agents/plugins/opencode-maestro/claude-proxy.mjs:115-124` — change `contextWindow: 200000` to `250000` in the `claude-opus-4-7` Claude CLI proxy model entry, update the comment.
...
rg -n 'claude-opus-4-7' .agents/plugins/opencode-maestro/config-hook.mjs .agents/plugins/opencode-maestro/claude-proxy.mjs
# Doc reflects 250K:
...
- [ ] `CLAUDE_MODEL_LIMITS["claude-opus-4-7"].context === 250000` in `config-hook.mjs`.
  ...
  verify:
    method: bash
    run: "rg -n 'claude-opus-4-7.*context.*250000' .agents/plugins/opencode-maestro/config-hook.mjs > /dev/null"
  ```
...
- [ ] `claude-opus-4-7` entry in `claude-proxy.mjs` reports `contextWindow: 250000`.
  ...
  verify:
    method: bash
    run: "rg -nU 'id:\\s*\"claude-opus-4-7\"[\\s\\S]{0,300}contextWindow:\\s*250000' .agents/plugins/opencode-maestro/claude-proxy.mjs > /dev/null"
  ```
...
- `.agents/plugins/opencode-maestro/config-hook.mjs:39-50` — the `CLAUDE_MODEL_LIMITS` source-of-truth map.
- `.agents/plugins/opencode-maestro/claude-proxy.mjs:115-124` — Claude CLI proxy model list entry for 4.7.
