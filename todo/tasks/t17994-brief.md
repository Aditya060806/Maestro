...
Make a successful transient systemd launch authoritative unless maestro proves the unit has no live worker process identity. A missing pid-file is an ambiguous handoff state, not proof that launch failed.
