...
Create the Vault RFC that defines maestro protected data classes, supported threat environments, trust boundaries, cryptographic design constraints, and phased architecture for local machines, third-party VPS hosts, public/private Git transports, third-party AI providers, and future local LLM use.
...
- [ ] Existing encryption-stack docs clarify gopass/SOPS/gocryptfs roles vs maestro Vault.
