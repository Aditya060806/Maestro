...
- **Created by:** Aditya060806 (human, interactive session)
- **Conversation context:** While manually reviewing issue #18428 we noticed the
  ...
  cycle. Log investigation (`~/.maestro/logs/pulse-wrapper.log`) showed three
...
- [ ] ShellCheck clean on the modified file.
  ...
  ```
- [ ] The `triage-failed` label is provisioned in the `Aditya060806/Maestro` repo
...
- `~/.maestro/logs/pulse-wrapper.log` — historical evidence of #18428 failures
- `~/.maestro/.agent-workspace/tmp/triage-cache/Aditya060806_maestro-18428.hash` —
