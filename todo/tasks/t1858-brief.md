...
Key files:
- `.agents/plugins/opencode-maestro/provider-auth.mjs` — the target (811 lines)
- `.agents/plugins/opencode-maestro/oauth-pool.mjs` — related, imports from this file; ensure no API breakage
- `.agents/plugins/opencode-maestro/index.mjs` — plugin entry point that wires the auth hook
...
- `.agents/plugins/opencode-maestro/provider-auth.mjs` — target file (811 lines, complexity 252)
- `.agents/plugins/opencode-maestro/oauth-pool.mjs` — imports from provider-auth; check for coupling
- `.agents/plugins/opencode-maestro/index.mjs` — wires the hook; verify integration unchanged
