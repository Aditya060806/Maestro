...
- `READ: gh api "repos/Aditya060806/Maestro/branches/main/protection"` — see current required status checks
- `READ: gh api "repos/Aditya060806/Maestro/branches/main/protection/required_status_checks"` — same, narrower
...
2. Inspect current branch protection required checks:
    ...
    ```bash
    gh api "repos/Aditya060806/Maestro/branches/main/protection" --jq '.required_status_checks'
    ```
...
4. Add the check to branch protection. Two options:
   - Via `gh` CLI:
     ...
     ```bash
     gh api -X PATCH "repos/Aditya060806/Maestro/branches/main/protection/required_status_checks" \
   ...
   - Via the web UI at `https://github.com/Aditya060806/Maestro/settings/branches`.
...
gh api "repos/Aditya060806/Maestro/branches/main/protection/required_status_checks" \
