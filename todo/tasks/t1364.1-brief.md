...
- Survey existing maestro safety mechanisms: pre-edit-check.sh branch protection, security rules in build.txt
...
- Design policy schema for repos.json / .maestro.json configuration
...
- [ ] Policy schema supports per-repo override via repos.json or .maestro.json
