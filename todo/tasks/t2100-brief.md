...
2. **t2102 (#19037)** — Pull `$maestro_path` fresh before running `complexity-scan-helper.sh ratchet-check` so the proposal reflects current main. Secondary cause of the #19024 duplicate.
...
- Triage evidence: https://github.com/Aditya060806/Maestro/issues/19024#issuecomment-4248172074
