...
- **Scope of impact:** any repo with a `tier:reasoning` parent task and two or more pulse runners. The maestro repo has parent tasks for roadmap epics — this pattern will recur.
