...
Create a dedicated Context7 CLI subagent and update Context7 documentation so maestro supports a clear hybrid strategy: MCP-first for normal workflows, CLI fallback for shell-native and constrained cases.
