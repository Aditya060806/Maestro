...
This template provides a comprehensive workflow for optimizing WordPress website performance using the Maestro framework.
...
cp ~/.maestro/reports/pagespeed/lighthouse_*.json "weekly-reports/lighthouse-$DATE.json"
EOF
...
~/git/maestro/.agents/scripts/pagespeed-helper.sh. Focus on:
...
./.agents/scripts/pagespeed-helper.sh report ~/.maestro/reports/pagespeed/lighthouse_*.json
```text
