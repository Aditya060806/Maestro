...
| Location | Purpose |
|----------|---------|
| `~/.config/maestro/` | **Secrets only** - `credentials.sh` (600 perms) |
...
bash ~/Git/maestro/.agents/scripts/setup-local-api-keys.sh add 'export TOKEN="xxx"'
...
cat ~/Git/maestro/AGENTS.md

# Access working directories
ls ~/.maestro/.agent-workspace/
```
