...
maestro is MIT licensed. You may use, copy, modify, and redistribute it,
...
```text
Copyright (c) 2025-2026 Aditya Pandey and Harvest
```
...
commercial product derived from maestro patterns or code, please add visible
credit in your README, documentation, or about page:

```markdown
Based on or inspired by [maestro](https://github.com/Aditya060806/Maestro),
Copyright (c) 2025-2026 Aditya Pandey and Harvest, MIT licensed.
```
...
Several maestro subsystems are intentionally traceable through public history,
...
If you are building on maestro and want the right credit text, open a discussion
