...
**Preferred method:** Use `/log-issue-maestro` in your AI assistant session. This command:
...
3. Clone your fork: `git clone https://github.com/YOUR_USERNAME/maestro.git`
4. Create a safe linked worktree for your change: `git worktree add ../maestro-feature-your-feature -b feature/your-feature main && cd ../maestro-feature-your-feature`
5. Make your changes
...
a GitHub issue. Prefer using `/log-issue-maestro` to file the issue or request,
...
```bash
# Clone and install
git clone https://github.com/Aditya060806/Maestro.git
cd maestro
./setup.sh
...
maestro is an opinionated framework. Architectural decisions — what the project integrates with, supports, tests against, or bundles — are made by maintainers.
