...
_test_create_subtasks_cross_repo() {
	(
		...
		# Task t99998 does not exist in the maestro repo TODO.md
...
_test_create_subtasks_not_in_db_dedup() {
	(
		...
		# incorrectly tries to subtask in the maestro context (t1238 root cause).
		sqlite3 "$SUPERVISOR_DB" "
...
_test_malformed_null_string_empty() {
	...
	# fails at parent_task_not_found (t555 is not in the maestro TODO.md).
