...
export MAESTRO_SKIP_SYSTEMD_WORKER_SERVICE=0
...
assert_contains "$STUB_SYSTEMD_RUN_LOG" '--unit=maestro-worker-23073-' 'expected worker transient unit launch'
...
assert_contains "$LOGFILE" 'systemd unit maestro-worker-23073-' 'expected systemd unit in launch diagnostic'
...
assert_contains "$LOGFILE" 'systemd unit maestro-worker-23524-' 'expected systemd unit in fallback diagnostic'
