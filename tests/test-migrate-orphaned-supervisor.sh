...
AGENTS_DIR="$TEST_HOME/.maestro/agents"
...
if command -v crontab &>/dev/null; then
	...
	{
		echo "# maestro: test-keep-this"
		echo "*/5 * * * * echo keep-this # maestro: test-keep"
		echo "*/2 * * * * /bin/bash /home/test/.maestro/agents/scripts/supervisor-helper.sh pulse >> /tmp/test.log 2>&1 # maestro: supervisor-pulse"
	} | crontab - 2>/dev/null
