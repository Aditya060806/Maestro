...
# --- Test DB Setup ---
TEST_DIR=$(mktemp -d)
export MAESTRO_SUPERVISOR_DIR="$TEST_DIR"
...
# The pulse lock directory lives inside MAESTRO_SUPERVISOR_DIR
...
{"type":"text","timestamp":1770606693412,"part":{"type":"text","text":"Task eval-t192a is complete. PR created: https://github.com/Aditya060806/Maestro/pull/718\n\nImplemented the feature successfully."}}
...
if echo "$eval_result" | grep -q "complete.*https://github.com/Aditya060806/Maestro/pull/718"; then
