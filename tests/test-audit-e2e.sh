...
VALUES
    ('sonarcloud', 'Aditya060806_maestro', strftime('%Y-%m-%dT%H:%M:%SZ', 'now'), 3, 3, 'complete'),
    ('codacy', 'maestro', strftime('%Y-%m-%dT%H:%M:%SZ', 'now'), 3, 3, 'complete'),
    ('coderabbit', 'maestro', strftime('%Y-%m-%dT%H:%M:%SZ', 'now'), 2, 2, 'complete'),
    ('codefactor', 'maestro', strftime('%Y-%m-%dT%H:%M:%SZ', 'now'), 2, 2, 'complete');
SQL
	return 0
}
