...
A non-technical guide to understanding and using the Maestro Framework.
...
> "Read ~/git/maestro/AGENTS.md for guidance"
...
| `~/.maestro/.agent-workspace/` folder | Your personal working directory |
...
No. The framework creates files only in organized directories (`~/.maestro/.agent-workspace/work/`, etc.), never randomly in your home folder.
...
- **Issues:** [GitHub Issues](https://github.com/Aditya060806/Maestro/issues)
- **Documentation:** Browse the wiki pages
- **Source Code:** [GitHub Repository](https://github.com/Aditya060806/Maestro)
