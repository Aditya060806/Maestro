...
export type GuiPulseIssueOrigin = "maestro_created" | "self_created" | "maintainer_created" | "origin_interactive" | "third_party" | "imported" | "unknown";
...
export const STATUS_ROUTE_MANIFEST: GuiRouteManifest = {
  ...
  command_pattern: ["maestro", "status"],
...
export const VAULT_STATUS_ROUTE_MANIFEST: GuiRouteManifest = {
  ...
  command_pattern: ["maestro", "vault", "status"],
...
export const APP_ACTION_ROUTE_MANIFEST: GuiRouteManifest = {
  ...
  command_pattern: ["allowlisted", "maestro", "setup/update", "background-job"],
  redactions: ["secret_values", "credential_paths", "private_key_material"],
};
...
export const PULSE_WORKERS_ACTION_ROUTE_MANIFEST: GuiRouteManifest = {
  ...
  command_pattern: ["allowlisted", "maestro", "pulse/worker-diagnostics", "background-job"],
...
export const GUI_FILE_ROOTS: readonly GuiFileRootDefinition[] = [
  {
    id: "agents",
    label: "Agents",
    path_ref: "~/.maestro/agents",
    description: "Agent, workflow, tool, service, and reference files deployed by maestro.",
    preview_policy: "agents_markdown_and_code",
  },
  {
    id: "config",
    label: "Config",
    path_ref: "~/.config/maestro",
    description: "Local maestro configuration files. Contents stay hidden until a redaction policy lands.",
  ...
  },
  {
    ...
    label: "Local Setup",
    path_ref: "~/.maestro",
    description: "Local maestro runtime folders, cache, memory, logs, and deployed assets.",
    preview_policy: "metadata_only",
  },
  {
    id: "git",
