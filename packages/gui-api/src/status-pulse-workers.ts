...
const DEFAULT_SCOPE = "local maestro telemetry";
const DEFAULT_METRICS_PATH_REF = "~/.maestro/logs/headless-runtime-metrics.jsonl";
const DEFAULT_PULSE_STATS_PATH_REF = "~/.maestro/logs/pulse-stats.json";
const DEFAULT_RESOURCE_METRICS_PATH_REF = "~/.maestro/logs/resource-metrics.jsonl";
const DEFAULT_TOKEN_REPORTS_ROOT_REF = "~/.maestro/_reports/token-use";
...
export function readPulseWorkersSummary(options: PulseWorkersAdapterOptions = {}): { summary: GuiPulseWorkerSummary; source_path_refs: string[] } {
  ...
  const oauthPoolPath = options.oauthPoolPath ?? expandHome("~/.maestro/oauth-pool.json");
