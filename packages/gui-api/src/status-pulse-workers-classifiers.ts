...
const KNOWN_ISSUE_ORIGINS = new Set<GuiPulseIssueOrigin>(["maestro_created", "self_created", "maintainer_created", "origin_interactive", "third_party", "imported", "unknown"]);
const ISSUE_ORIGIN_MATCHERS: Array<{ pattern: RegExp; origin: GuiPulseIssueOrigin }> = [
  ...
  { pattern: /maestro/, origin: "maestro_created" },
];
