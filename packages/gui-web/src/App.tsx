import type { GuiResponseEnvelope, GuiStatusData } from "@maestro/gui-shared";
...
export const appearanceStorageKeys = {
  accentHue: "maestro-gui-accent-hue",
  contrast: "maestro-gui-contrast",
  font: "maestro-gui-font",
  fontSize: "maestro-gui-font-size",
  machineRail: "maestro-gui-show-machine-rail",
  showBorders: "maestro-gui-show-borders",
  showNavCounts: "maestro-gui-show-nav-counts",
  sidebarWidth: "maestro-gui-sidebar-width",
  theme: "maestro-gui-theme",
} as const;
...
export function App(): ReactElement {
  ...
  useEffect(() => {
    ...
    window.addEventListener("maestro:toggle-machine-rail", toggleMachineRail);

    return () => {
      mediaQuery.removeEventListener("change", updateSystemTheme);
      window.removeEventListener("maestro:toggle-machine-rail", toggleMachineRail);
    };
  }, []);
...
export function AppLoadingSkeleton({ machineRailVisible }: { machineRailVisible: boolean }): ReactElement {
  return (
    <main className={machineRailVisible ? "app-shell app-loading-shell" : "app-shell app-loading-shell machine-rail-collapsed"} aria-busy="true" aria-label="Loading maestro interface">
...
function LoadingBrandOverlay(): ReactElement {
  return (
    <div className="loading-brand-overlay" aria-label="Starting maestro" role="status">
