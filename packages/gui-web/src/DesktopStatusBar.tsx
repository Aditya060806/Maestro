import type { GuiStatusData } from "@maestro/gui-shared";
import type { ReactElement } from "react";

export function DesktopStatusBar({ status }: { status: GuiStatusData }): ReactElement {
  const version = status.update.installed_version !== "unknown" ? status.update.installed_version : status.maestro_version;
