import type { GuiFileRootId, GuiStatusData } from "@maestro/gui-shared";
...
export const text = {
  ...
  config: "Config",
  contrast: "Contrast",
  configIntro: "Read-only file explorer for ~/.config/maestro. Contents stay hidden until redaction rules land.",
  copyPath: "Copy path",
  dashboard: "Dashboard",
  help: "Help",
  helpIntro: "Command shortcuts, navigation hints, and maestro workflow guidance will collect here.",
  domains: "Domains",
  ...
  installationIntro: "Optional maestro setup/update components. Toggles are shown as planned controls until writes are enabled.",
  install: "Install",
  bookmarks: "Bookmarks",
  calendars: "Calendars",
  campaigns: "Campaigns",
  ...
  devops: "DevOps",
  devices: "Devices",
  devicesIntro: "Device inventory and pairing controls are planned for local and remote maestro installations.",
  ...
  localSetupIntro: "Read-only file explorer for ~/.maestro runtime folders, cache, memory, and deployed assets.",
  ...
  aiApps: "AI Apps",
  aiAppsIntro: "Local AI app, CLI, config, and maestro prompt targets. Versions are read-only and compare installed maestro files with the current checkout.",
  ...
  setup: "Setup",
  setupTargets: "Installed maestro targets",
  ...
  vaultStatus: "Status",
  vaultSync: "Sync",
  vaultTooltip: "Encrypted by maestro Vault; contents visible only when unlocked through app or authorised vault commands.",
  vaultUnlockCta: "Unlock Vault",
  vaultUnlockHint: "Run `maestro vault unlock` in a local terminal and enter the passphrase only into the hidden prompt.",
  website: "Website",
  websites: "Websites",
  websitesIntro: "Websites, landing pages, publishing homes, and ownership status are planned.",
  workspaceLabel: "maestro workspace",
  vpnsProxies: "VPNs & Proxies",
  vpnsProxiesIntro: "VPN and proxy inventory is planned for network-aware device management.",
  navigationLabel: "maestro navigation",
} as const;
...
export const navGroups: SurfaceNavGroup[] = [
  {
    ...
    mode: "devops",
    items: [
      { id: "devices", label: text.devices, description: "Installed maestro machines", icon: "device", badge: text.planned },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "agents", label: "Agents", description: "~/.maestro/agents explorer", icon: "document" },
      { id: "config", label: text.config, description: "~/.config/maestro explorer", icon: "settings" },
      { id: "localSetup", label: text.localSetup, description: "~/.maestro explorer", icon: "terminal" },
