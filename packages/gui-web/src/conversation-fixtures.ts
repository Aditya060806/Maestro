...
export const conversationThreads: GuiConversationThread[] = [
  {
    conversation: { id: "channel-general", type: "channel", title: "general", scope: { tenant_ref: "local", workspace_ref: "maestro", repo_ref: null }, source_ref: "seed:channels/general", status: "read_only", created_at: "2026-06-27T00:00:00Z", updated_at: "2026-06-27T12:20:00Z" },
    participants: [
      ...
      { id: "participant-ai", conversation_id: "channel-general", kind: "ai_assistant", display_name: "Maestro", identity_ref: null, agent_ref: "maestro", worker_ref: null, membership_state: "active", joined_at: "2026-06-27T00:00:00Z" },
    ...
    parts: [
      ...
      { id: "part-general-2", message_id: "message-general-2", kind: "text", ordinal: 1, text: "Mention @Maestro or a worker to turn a thread into an audited task once write routes land.", payload_json: null, file_ref: null, source_ref: null },
      { id: "part-general-3", message_id: "message-general-3", kind: "tambo_component", ordinal: 1, text: null, payload_json: { component: "TaskCard", tenant_ref: "local", session_ref: "channel-general", read_only: true, props: { title: "Integrate Tambo GenUI cards", status: "read-only preview", priority: "high", owner: "Maestro", repo: "maestro", reference: "#25713" } }, file_ref: null, source_ref: "tambo:seed" },
    ],
  ...
  {
    conversation: { id: "channel-workers", type: "channel", title: "worker-feed", scope: { tenant_ref: "local", workspace_ref: "maestro", repo_ref: "current" }, source_ref: "seed:channels/worker-feed", status: "read_only", created_at: "2026-06-27T00:00:00Z", updated_at: "2026-06-27T12:30:00Z" },
  ...
  {
    conversation: { id: "dm-maestro", type: "dm", title: "Maestro", scope: { tenant_ref: "local", workspace_ref: "maestro", repo_ref: null }, source_ref: "seed:dms/maestro", status: "read_only", created_at: "2026-06-27T00:00:00Z", updated_at: "2026-06-27T12:40:00Z" },
    participants: [{ id: "participant-dm-local", conversation_id: "dm-maestro", kind: "human", display_name: "Local user", identity_ref: "local:user", agent_ref: null, worker_ref: null, membership_state: "active", joined_at: "2026-06-27T00:00:00Z" }, { id: "participant-dm-ai", conversation_id: "dm-maestro", kind: "ai_assistant", display_name: "Maestro", identity_ref: null, agent_ref: "maestro", worker_ref: null, membership_state: "active", joined_at: "2026-06-27T00:00:00Z" }],
    messages: [{ id: "message-dm-1", conversation_id: "dm-maestro", sender_participant_id: "participant-dm-ai", sender_kind: "ai_assistant", sequence: 1, status: "delivered", usage: null, created_at: "2026-06-27T12:40:00Z", edited_at: null }],
    parts: [
      ...
      { id: "part-dm-2", message_id: "message-dm-1", kind: "approval_prompt", ordinal: 2, text: null, payload_json: { component: "ApprovalPromptCard", tenant_ref: "local", session_ref: "dm-maestro", read_only: true, props: { action: "Dispatch worker", reason: "Requires audited approval backend before mutation", risk: "medium", requested_by: "Maestro", disabled: true } }, file_ref: null, source_ref: "tambo:seed" },
    ],
    reactions: [],
    read_states: [{ conversation_id: "dm-maestro", participant_id: "participant-dm-local", last_read_message_id: null, last_read_sequence: 0, updated_at: "2026-06-27T12:00:00Z" }],
  },
];
