  ...
  return (
    <article className="repo-setup-card">
      ...
      <div className="repo-card-meta">
        <Detail label="maestro init" value={repo.maestro_version} />
  ...
  return (
    <section className="panel setup-targets-panel" aria-label={text.setupTargets}>
      ...
      {status.setup_targets.length === 0 ? (
        <p className="empty-state">No maestro setup targets were reported.</p>
      ) : (
  ...
  return (
    <article className="ai-app-card">
      ...
      <div className="repo-card-meta">
        ...
        <Detail label="maestro" value={app.maestro_version} />
      ...
      <div className="setup-path-list">
        ...
        <PathRow label="maestro" pathRef={app.maestro_target_path_ref} />
      </div>
    </article>
  );
}
