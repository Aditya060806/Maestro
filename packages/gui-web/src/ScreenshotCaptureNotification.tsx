...
export function ScreenshotCaptureNotificationHost(): ReactElement | null {
  ...
  useEffect(() => {
    ...
    window.addEventListener("maestro:screenshot-captured", showScreenshotNotification);
    return () => window.removeEventListener("maestro:screenshot-captured", showScreenshotNotification);
  }, []);
