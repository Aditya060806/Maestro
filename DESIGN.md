...
- The approved Maestro app mark is the cyan terminal prompt glyph used by the `maestro.sh` navigation logo and favicon.
...
6. Regenerate brand guideline artifacts after changing this file with `maestro design guidelines . --pdf`.
