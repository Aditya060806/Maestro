...
# Maestro Framework - Context Instructions

This codebase is the **maestro framework** - a collection of AI agent instructions
...
- **`.agents/AGENTS.md`** - User guide distributed to `~/.maestro/agents/`
...
4. **Security-first**: Credentials stored in `~/.config/maestro/credentials.sh`

## When Analyzing This Codebase

- **For architecture understanding**: Focus on `.agents/AGENTS.md` and `.agents/maestro/architecture.md`
...
| Task | Key Files |
|------|-----------|
| Add new service | `.agents/maestro/add-new-mcp-to-maestro.md` |
